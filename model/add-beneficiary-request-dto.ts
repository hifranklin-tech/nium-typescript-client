...
export interface AddBeneficiaryRequestDTO {
    ...
    /**
     * This field accepts the [ISO-2 country code](/docs/currency-and-country-codes) of the beneficiary.
     * @type {string}
     * @memberof AddBeneficiaryRequestDTO
     */
    ...
    /**
     * This field accepts the 3-letter [ISO-4217 destination currency code](/docs/currency-and-country-codes).
     * @type {string}
     * @memberof AddBeneficiaryRequestDTO
     */
