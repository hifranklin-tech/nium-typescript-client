...
// May contain unused imports in some cases
// @ts-ignore
import type { CardMetaDataResponseDTO } from './card-meta-data-response-dto';
...
export interface BeneficiaryResponseDTO {
    /**
     * 
     * @type {AccountVerificationInfoDTO}
    ...
    /**
     * This field contains the 3-letter [ISO-4217 destination currency code](/docs/currency-and-country-codes) of the payout as per the destination country from supported corridors.
     * @type {string}
     * @memberof BeneficiaryResponseDTO
     */
