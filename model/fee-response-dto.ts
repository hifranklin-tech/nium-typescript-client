...
export interface FeeResponseDTO {
    ...
    /**
     * This field contains the 3-letter [ISO-4217 authorization currency code](/docs/currency-and-country-codes).
     * @type {string}
     * @memberof FeeResponseDTO
     */
    'authCurrency'?: string;
    /**
     * This field contains the 3-letter [ISO-4217 transaction currency code](/docs/currency-and-country-codes).
     * @type {string}
     * @memberof FeeResponseDTO
     */
    'transactionCurrency'?: string;
    /**
     * This field contains the 3-letter [ISO-4217 fee currency code](/docs/currency-and-country-codes).
     * @type {string}
     * @memberof FeeResponseDTO
     */
    'feeCurrency'?: string;
