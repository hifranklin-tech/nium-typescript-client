...
export interface IndividualCustomerResponseDTO {
    ...
    /**
     * This field contains the 3-letter [ISO-4217 currency code](/docs/currency-and-country-codes) in which estimated monthly funding is expected in the wallet, for example, SGD.
     * @type {string}
     * @memberof IndividualCustomerResponseDTO
     */
    ...
    'mobile'?: string;
    /**
     * This field contains the 2-letter [ISO Alpha-2 country code](/docs/currency-and-country-codes) denoting the customer [INDIVIDUAL] or applicant [CORPORATE] citizenship.
     * @type {string}
     * @memberof IndividualCustomerResponseDTO
     */
    'nationality'?: string;
