...
export interface BeneficiaryValidationRequestDTO {
    ...
    /**
     * The 2-letter [ISO-2 country code](doc:currency-and-country-codes) of the beneficiary/bank.
     * @type {string}
     * @memberof BeneficiaryValidationRequestDTO
     */
    ...
    /**
     * The 2-letter [ISO-2 country code](doc:currency-and-country-codes) of the destination country.
     * @type {string}
     * @memberof BeneficiaryValidationRequestDTO
     */
