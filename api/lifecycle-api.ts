...
// @ts-ignore
import type { ActivateCardResponseDTO } from '../model';
// @ts-ignore
import type { ActivateCardResponseV2DTO } from '../model';
// @ts-ignore
import type { AddCardRequest } from '../model';
// @ts-ignore
import type { AddCardResponseDTO } from '../model';
// @ts-ignore
import type { AddCardV2Request } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { BlockCodeCardResponseDTO } from '../model';
// @ts-ignore
import type { BlockCodeDTO } from '../model';
// @ts-ignore
import type { CardAssignResponseDTO } from '../model';
// @ts-ignore
import type { CardDetails } from '../model';
// @ts-ignore
import type { CardResponseDTO } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { ReplaceCardRequest } from '../model';
// @ts-ignore
...
export const LifecycleApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Enables you to fetch the card details of a particular card.  >⚠️ WARNING   >This API version is deprecated. Eventually, a deprecated API version becomes unsupported. [Card Details V2](ref:carddetailsv2) is the latest version of this API.
