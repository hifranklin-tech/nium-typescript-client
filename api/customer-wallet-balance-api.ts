...
// @ts-ignore
import type { WalletsSearchDTO } from '../model';
/**
...
export const CustomerWalletBalanceApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {AddWalletRequestDTO} addWalletRequestDTO 
         ...
         * @param {string} clientHashId Unique client identifier generated and shared before the initial request.
         * @param {string} customerHashId Unique customer identifier generated when the customer is created.
         * @param {WalletsSearchDTO} walletsSearchDTO 
         * @param {string} [xRequestId] Enter a universally unique identifier (UUID).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getWallet: async (clientHashId: string, customerHashId: string, walletsSearchDTO: WalletsSearchDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            assertParamExists('getWallet', 'clientHashId', clientHashId)
            // verify required parameter 'customerHashId' is not null or undefined
            assertParamExists('getWallet', 'customerHashId', customerHashId)
            // verify required parameter 'walletsSearchDTO' is not null or undefined
            assertParamExists('getWallet', 'walletsSearchDTO', walletsSearchDTO)
            const localVarPath = `/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet`
                .replace(`{${"clientHashId"}}`, encodeURIComponent(String(clientHashId)))
                .replace(`{${"customerHashId"}}`, encodeURIComponent(String(customerHashId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            if (walletsSearchDTO !== undefined) {
                for (const [key, value] of Object.entries(walletsSearchDTO)) {
         ...
         * @param {UpdateWalletRequestDTO} updateWalletRequestDTO 
         * @param {string} [xRequestId] Enter a universally unique identifier (UUID).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
...
export const CustomerWalletBalanceApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getWallet(clientHashId: string, customerHashId: string, walletsSearchDTO: WalletsSearchDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletResponseDTO2>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getWallet(clientHashId, customerHashId, walletsSearchDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CustomerWalletBalanceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        getWallet(requestParameters: CustomerWalletBalanceApiGetWalletRequest, options?: RawAxiosRequestConfig): AxiosPromise<WalletResponseDTO2> {
            return localVarFp.getWallet(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletsSearchDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows you to update a specific wallet.
         * @summary Update Wallet
...
export interface CustomerWalletBalanceApiGetWalletRequest {
    ...
    readonly walletsSearchDTO: WalletsSearchDTO
...
export class CustomerWalletBalanceApi extends BaseAPI {
    ...
    public getWallet(requestParameters: CustomerWalletBalanceApiGetWalletRequest, options?: RawAxiosRequestConfig) {
        return CustomerWalletBalanceApiFp(this.configuration).getWallet(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletsSearchDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
