...
// @ts-ignore
import type { VerificationOfPayeeConsentRequestDTO } from '../model';
// @ts-ignore
import type { VerificationOfPayeeErrorResponse } from '../model';
// @ts-ignore
import type { VirtualAccountRequestDTO } from '../model';
// @ts-ignore
...
export const CustomerVirtualAccountsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        accountOwnershipCertificate: async (clientHashId: string, customerHashId: string, currentAccountBalance?: boolean, currencies?: string, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} customerHashId Unique customer identifier generated when the customer is created.
         * @param {string} walletHashId Unique wallet identifier generated simultaneously with customer creation.
         * @param {PaymentIdTagRequestDTO} paymentIdTagRequestDTO 
         * @param {string} [xRequestId] Enter a universally unique identifier (UUID).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
         ...
         * @summary Verification of Payee Consent
         * @param {string} clientHashId Unique client identifier generated and shared before the initial request.
         * @param {string} customerHashId Unique customer identifier generated when the customer is created.
         * @param {string} walletHashId Unique wallet ID generated simultaneously along with customer creation.
         * @param {VerificationOfPayeeConsentRequestDTO} verificationOfPayeeConsentRequestDTO 
         * @param {string} [xRequestId] Enter a universally unique identifier (UUID).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        verificationOfPayee: async (clientHashId: string, customerHashId: string, walletHashId: string, verificationOfPayeeConsentRequestDTO: VerificationOfPayeeConsentRequestDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            assertParamExists('verificationOfPayee', 'clientHashId', clientHashId)
            // verify required parameter 'customerHashId' is not null or undefined
            assertParamExists('verificationOfPayee', 'customerHashId', customerHashId)
            // verify required parameter 'walletHashId' is not null or undefined
            assertParamExists('verificationOfPayee', 'walletHashId', walletHashId)
            // verify required parameter 'verificationOfPayeeConsentRequestDTO' is not null or undefined
            assertParamExists('verificationOfPayee', 'verificationOfPayeeConsentRequestDTO', verificationOfPayeeConsentRequestDTO)
            const localVarPath = `/api/v1/client/{clientHashId}/customer/{customerHashId}/wallet/{walletHashId}/paymentId/consent`
                .replace(`{${"clientHashId"}}`, encodeURIComponent(String(clientHashId)))
                .replace(`{${"customerHashId"}}`, encodeURIComponent(String(customerHashId)))
                .replace(`{${"walletHashId"}}`, encodeURIComponent(String(walletHashId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(verificationOfPayeeConsentRequestDTO, localVarRequestOptions, configuration)
         ...
         * @param {string} clientHashId Unique client identifier generated and shared before the initial request.
         * @param {string} customerHashId Unique customer identifier generated and shared before the initial request.
         * @param {string} walletHashId Unique wallet identifier generated and shared before the initial request.
         * @param {VirtualAccountRequestDTO} virtualAccountRequestDTO 
         * @param {string} [xRequestId] Enter a universally unique identifier (UUID).
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        virtualAccountDetails: async (clientHashId: string, customerHashId: string, walletHashId: string, virtualAccountRequestDTO: VirtualAccountRequestDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            ...
            // verify required parameter 'virtualAccountRequestDTO' is not null or undefined
            assertParamExists('virtualAccountDetails', 'virtualAccountRequestDTO', virtualAccountRequestDTO)
            ...
            if (virtualAccountRequestDTO !== undefined) {
                for (const [key, value] of Object.entries(virtualAccountRequestDTO)) {
         ...
         * @throws {RequiredError}
         */
        virtualAccountDetailsV2: async (clientHashId: string, customerHashId: string, walletHashId: string, virtualAccountRequestDTO: VirtualAccountRequestDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            ...
            // verify required parameter 'virtualAccountRequestDTO' is not null or undefined
            assertParamExists('virtualAccountDetailsV2', 'virtualAccountRequestDTO', virtualAccountRequestDTO)
...
export const CustomerVirtualAccountsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async accountOwnershipCertificate(clientHashId: string, customerHashId: string, currentAccountBalance?: boolean, currencies?: string, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountOwnershipCertificate(clientHashId, customerHashId, currentAccountBalance, currencies, xRequestId, options);
         ...
         * @throws {RequiredError}
         */
        async verificationOfPayee(clientHashId: string, customerHashId: string, walletHashId: string, verificationOfPayeeConsentRequestDTO: VerificationOfPayeeConsentRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.verificationOfPayee(clientHashId, customerHashId, walletHashId, verificationOfPayeeConsentRequestDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CustomerVirtualAccountsApi.verificationOfPayee']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * This API allows you to fetch virtual accounts assigned to a customer\'s wallet.  ⚠️ **WARNING**   To access updated functionality and features, we recommend using the latest version of this API: [Virtual Account Details V2](https://docs.nium.com/apis/reference/virtualaccountdetailsv2). Eventually, this API version will be deprecated and become unsupported. 
         ...
         * @throws {RequiredError}
         */
        async virtualAccountDetails(clientHashId: string, customerHashId: string, walletHashId: string, virtualAccountRequestDTO: VirtualAccountRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<WalletPaymentIdsResponseDTO>>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.virtualAccountDetails(clientHashId, customerHashId, walletHashId, virtualAccountRequestDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
         ...
         * @throws {RequiredError}
         */
        async virtualAccountDetailsV2(clientHashId: string, customerHashId: string, walletHashId: string, virtualAccountRequestDTO: VirtualAccountRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VirtualAccountResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.virtualAccountDetailsV2(clientHashId, customerHashId, walletHashId, virtualAccountRequestDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CustomerVirtualAccountsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        accountOwnershipCertificate(requestParameters: CustomerVirtualAccountsApiAccountOwnershipCertificateRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.accountOwnershipCertificate(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.currentAccountBalance, requestParameters.currencies, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * Assign virtual account numbers to customers so they can use a specific funding source. For more information, see [Virtual Accounts](/docs/virtual-account-number)
         * @summary Assign Payment ID
         ...
         * This request enables you to opt in or out of [Verification of Payee](/docs/vop-guidelines).
         * @summary Verification of Payee Consent
         * @param {CustomerVirtualAccountsApiVerificationOfPayeeRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        verificationOfPayee(requestParameters: CustomerVirtualAccountsApiVerificationOfPayeeRequest, options?: RawAxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.verificationOfPayee(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.verificationOfPayeeConsentRequestDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows you to fetch virtual accounts assigned to a customer\'s wallet.  ⚠️ **WARNING**   To access updated functionality and features, we recommend using the latest version of this API: [Virtual Account Details V2](https://docs.nium.com/apis/reference/virtualaccountdetailsv2). Eventually, this API version will be deprecated and become unsupported. 
         * @summary Virtual Account Details
        ...
        virtualAccountDetails(requestParameters: CustomerVirtualAccountsApiVirtualAccountDetailsRequest, options?: RawAxiosRequestConfig): AxiosPromise<Array<WalletPaymentIdsResponseDTO>> {
            return localVarFp.virtualAccountDetails(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.virtualAccountRequestDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows you to fetch virtual accounts assigned to a customer\'s wallet.
         * @summary Virtual Account Details V2
        ...
        virtualAccountDetailsV2(requestParameters: CustomerVirtualAccountsApiVirtualAccountDetailsV2Request, options?: RawAxiosRequestConfig): AxiosPromise<VirtualAccountResponseDTO> {
            return localVarFp.virtualAccountDetailsV2(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.virtualAccountRequestDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
    };
};
...
/**
 * Request parameters for verificationOfPayee operation in CustomerVirtualAccountsApi.
 */
export interface CustomerVirtualAccountsApiVerificationOfPayeeRequest {
    /**
     * Unique client identifier generated and shared before the initial request.
     */
    readonly clientHashId: string
    ...
    /**
     * Unique wallet ID generated simultaneously along with customer creation.
     */
    readonly walletHashId: string

    readonly verificationOfPayeeConsentRequestDTO: VerificationOfPayeeConsentRequestDTO
...
export interface CustomerVirtualAccountsApiVirtualAccountDetailsRequest {
    ...
    /**
     * Unique customer identifier generated and shared before the initial request.
     */
    readonly customerHashId: string

    /**
     * Unique wallet identifier generated and shared before the initial request.
     */
    readonly walletHashId: string

    readonly virtualAccountRequestDTO: VirtualAccountRequestDTO
...
export class CustomerVirtualAccountsApi extends BaseAPI {
    ...
    public accountOwnershipCertificate(requestParameters: CustomerVirtualAccountsApiAccountOwnershipCertificateRequest, options?: RawAxiosRequestConfig) {
        return CustomerVirtualAccountsApiFp(this.configuration).accountOwnershipCertificate(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.currentAccountBalance, requestParameters.currencies, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @throws {RequiredError}
     */
    public verificationOfPayee(requestParameters: CustomerVirtualAccountsApiVerificationOfPayeeRequest, options?: RawAxiosRequestConfig) {
        return CustomerVirtualAccountsApiFp(this.configuration).verificationOfPayee(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.verificationOfPayeeConsentRequestDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public virtualAccountDetails(requestParameters: CustomerVirtualAccountsApiVirtualAccountDetailsRequest, options?: RawAxiosRequestConfig) {
        return CustomerVirtualAccountsApiFp(this.configuration).virtualAccountDetails(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.virtualAccountRequestDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public virtualAccountDetailsV2(requestParameters: CustomerVirtualAccountsApiVirtualAccountDetailsV2Request, options?: RawAxiosRequestConfig) {
        return CustomerVirtualAccountsApiFp(this.configuration).virtualAccountDetailsV2(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.walletHashId, requestParameters.virtualAccountRequestDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
}
