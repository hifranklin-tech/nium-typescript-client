...
// @ts-ignore
import type { ErrorResponse401 } from '../model';
// @ts-ignore
import type { ErrorResponse403 } from '../model';
// @ts-ignore
import type { ErrorResponse500 } from '../model';
// @ts-ignore
import type { ExchangeRateV2ResponseDto } from '../model';
// @ts-ignore
import type { ExchangeRatesGetResponse } from '../model';
// @ts-ignore
import type { HistoricalRateErrorResponse400 } from '../model';
// @ts-ignore
...
export const RatesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} sourceCurrencyCode The 3-letter [currency-and-country-codes](https://docs.nium.com/apis/docs/currency-and-country-codes).
         * @param {string} destinationCurrencyCode The 3-letter [currency-and-country-codes](https://docs.nium.com/apis/docs/currency-and-country-codes).
...
export interface RatesApiAggregatedExchangeRatesRequest {
    /**
     * The 3-letter [currency-and-country-codes](https://docs.nium.com/apis/docs/currency-and-country-codes).
     */
