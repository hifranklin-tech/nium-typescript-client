...
export const ReferenceDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} countryCode This field accepts the [2-letter ISO-2 country code](/docs/currency-and-country-codes) of a beneficiary.
         ...
         * @param {string} clientHashId Unique client identifier generated and shared before API handshake.
         * @param {string} countryCode This field accepts the [2-letter ISO-2 country code](/docs/currency-and-country-codes) for which routing code search is initiated.
         ...
         * @param {string} [currencyCode] This field accepts the [3-letter ISO-4217 currency code](/docs/currency-and-country-codes) for which routing code search is to be initiated.
...
export interface ReferenceDataApiFetchBankDetailsusingRoutingCodeRequest {
    ...
    /**
     * This field accepts the [2-letter ISO-2 country code](/docs/currency-and-country-codes) of a beneficiary.
     * @type {string}
     * @memberof ReferenceDataApiFetchBankDetailsusingRoutingCode
     */
