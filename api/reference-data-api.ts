...
export const ReferenceDataApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchSupportedCorridorsV3(clientHashId: string, beneficiaryAccountType?: FetchSupportedCorridorsV3BeneficiaryAccountTypeEnum, customerType?: FetchSupportedCorridorsV3CustomerTypeEnum, destinationCountry?: string, destinationCurrency?: string, order?: FetchSupportedCorridorsV3OrderEnum, page?: number, payoutMethod?: FetchSupportedCorridorsV3PayoutMethodEnum, payoutMethodCategory?: FetchSupportedCorridorsV3PayoutMethodCategoryEnum, routingCodeType?: FetchSupportedCorridorsV3RoutingCodeTypeEnum, size?: number, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SupportedCorridorsResponse>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ReferenceDataApi.fetchSupportedCorridorsV3']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * This API will allow you to search the routing code details using bank name.
...
export const ReferenceDataApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * This API will allow you to fetch the supported corridors for remittance with details.
         * @summary Fetch Supported Corridors V3
         * @param {ReferenceDataApiFetchSupportedCorridorsV3Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        fetchSupportedCorridorsV3(requestParameters: ReferenceDataApiFetchSupportedCorridorsV3Request, options?: RawAxiosRequestConfig): AxiosPromise<SupportedCorridorsResponse> {
...
/**
 * Request parameters for fetchSupportedCorridorsV3 operation in ReferenceDataApi.
 * @export
 * @interface ReferenceDataApiFetchSupportedCorridorsV3Request
 */
export interface ReferenceDataApiFetchSupportedCorridorsV3Request {
    /**
     * Unique client identifier generated and shared before API handshake.
     * @type {string}
     * @memberof ReferenceDataApiFetchSupportedCorridorsV3
     */
    readonly clientHashId: string
    ...
    /**
     * This field accepts the different modes of payout.
     * @type {'LOCAL' | 'SWIFT' | 'WALLET' | 'CASH' | 'CARD' | 'PROXY'}
     * @memberof ReferenceDataApiFetchSupportedCorridorsV3
     */
     ...
     * @type {'visaDirect' | 'sepa' | 'ach' | 'proxy' | 'proxyFps' | 'wallet' | 'wireForeign' | 'proxyDuitnow' | 'wireLocal' | 'proxyBank' | 'cash' | 'unionPay' | 'proxyUpi'}
     * @memberof ReferenceDataApiFetchSupportedCorridorsV3
     */
...
export class ReferenceDataApi extends BaseAPI {
     ...
     * @memberof ReferenceDataApi
     */
    public fetchSupportedCorridorsV3(requestParameters: ReferenceDataApiFetchSupportedCorridorsV3Request, options?: RawAxiosRequestConfig) {
        return ReferenceDataApiFp(this.configuration).fetchSupportedCorridorsV3(requestParameters.clientHashId, requestParameters.beneficiaryAccountType, requestParameters.customerType, requestParameters.destinationCountry, requestParameters.destinationCurrency, requestParameters.order, requestParameters.page, requestParameters.payoutMethod, requestParameters.payoutMethodCategory, requestParameters.routingCodeType, requestParameters.size, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
