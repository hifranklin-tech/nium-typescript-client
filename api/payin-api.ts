...
export const PayinApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * This API can be used in Sandbox testing to simulate the inward receipt of transaction and credit funds into a wallet for testing purposes.  >ℹ️ INFO  >This API is for testing purpose only and not to be used in production. >Use a unique bankReferenceNumber every time you simulate receiving a transaction.
