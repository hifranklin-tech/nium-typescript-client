...
export const CustomerFeesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * This API allows you to levy custom fee.   >⚠️ WARNING   >Due to regulatory requirements, using the Fee endpoint requires explicit approval from Nium. Any fees charged to customers must be disclosed in the client’s terms and conditions and approved by Nium legal and compliance. If you have any questions, please reach out to your Nium account manager or [Nium Support](mailto:support@nium.com).
         * @summary Charge Fee
