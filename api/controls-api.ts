...
// @ts-ignore
import type { WalletApiResponseString } from '../model';
/**
...
export const ControlsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async updateChannelRestriction(clientHashId: string, customerHashId: string, walletHashId: string, cardHashId: string, channelActionRequestDTO: ChannelActionRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<WalletApiResponseString>> {
...
export const ControlsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        updateChannelRestriction(requestParameters: ControlsApiUpdateChannelRestrictionRequest, options?: RawAxiosRequestConfig): AxiosPromise<WalletApiResponseString> {
