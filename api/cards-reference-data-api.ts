...
export const CardsReferenceDataApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} fromCurrency The 3-letter [ISO-4217 currency code](/docs/currency-and-country-codes) of the transaction currency. Should be one of the applicable EEA currencies (EUR, BGN, HRK, CZK, DKK, HUF, PLN, RON, SEK, GBP, ISK, CHF and NOK).
         * @param {string} toCurrency The 3-letter [ISO-4217 currency code](/docs/currency-and-country-codes) of the cardholder billing currency. Should be one of the applicable EEA currencies (EUR, BGN, HRK, CZK, DKK, HUF, PLN, RON, SEK, GBP, ISK, CHF and NOK)
...
export interface CardsReferenceDataApiReferenceExchangeRateRequest {
    ...
    /**
     * The 3-letter [ISO-4217 currency code](/docs/currency-and-country-codes) of the transaction currency. Should be one of the applicable EEA currencies (EUR, BGN, HRK, CZK, DKK, HUF, PLN, RON, SEK, GBP, ISK, CHF and NOK).
     */
    readonly fromCurrency: string

    /**
     * The 3-letter [ISO-4217 currency code](/docs/currency-and-country-codes) of the cardholder billing currency. Should be one of the applicable EEA currencies (EUR, BGN, HRK, CZK, DKK, HUF, PLN, RON, SEK, GBP, ISK, CHF and NOK)
     */
