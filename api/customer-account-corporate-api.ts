...
// @ts-ignore
import type { ComplianceRFITemplateMetadataResponseDTO } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { CorporateCustomerRequestsDTO } from '../model';
// @ts-ignore
import type { CorporateDetailResponseDTO } from '../model';
// @ts-ignore
import type { CorporateEnrichedDetailResponseDTO } from '../model';
// @ts-ignore
...
export const CustomerAccountCorporateApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {UpdateCorporateCustomerRequestDTO} updateCorporateCustomerRequestDTO updateCorporateCustomerRequestsDTO
         * @param {string} [xRequestId] Enter a unique UUID value
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
