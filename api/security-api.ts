 ...
 * @export
 * @interface SecurityApiSetResetPINV2Request
 */
export interface SecurityApiSetResetPINV2Request {
    /**
     * Unique client identifier generated and shared before API handshake.
     * @type {string}
     * @memberof SecurityApiSetResetPINV2
     */
    readonly clientHashId: string
 ...
 * @export
 * @interface SecurityApiShowSecurityDetailsEncryptedRequest
 */
export interface SecurityApiShowSecurityDetailsEncryptedRequest {
    /**
     * Unique client identifier generated and shared before API handshake.
     * @type {string}
     * @memberof SecurityApiShowSecurityDetailsEncrypted
     */
    readonly clientHashId: string
