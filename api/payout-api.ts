...
// @ts-ignore
import type { ApiResponseOfWalletRefundResponseDTO } from '../model';
// @ts-ignore
...
// @ts-ignore
import type { PayoutApiError2 } from '../model';
// @ts-ignore
...
export const PayoutApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        cancelRemittance: async (clientHashId: string, customerHashId: string, systemReferenceNumber: string, walletHashId: string, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} walletHashId Unique wallet identifier generated simultaneously with customer creation.
         * @param {UpdateMandateRequestDTO} updateMandateRequestDTO updateMandateRequestDTO
         * @param {string} [xRequestId] Enter a unique UUID value.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        returnMandate: async (clientHashId: string, customerHashId: string, mandateId: string, transactionId: string, walletHashId: string, updateMandateRequestDTO: UpdateMandateRequestDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
...
export const PayoutApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async cancelRemittance(clientHashId: string, customerHashId: string, systemReferenceNumber: string, walletHashId: string, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CancelledRemittanceResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.cancelRemittance(clientHashId, customerHashId, systemReferenceNumber, walletHashId, xRequestId, options);
         ...
         * @throws {RequiredError}
         */
        async returnMandate(clientHashId: string, customerHashId: string, mandateId: string, transactionId: string, walletHashId: string, updateMandateRequestDTO: UpdateMandateRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PayoutApiError2>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.returnMandate(clientHashId, customerHashId, mandateId, transactionId, walletHashId, updateMandateRequestDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const PayoutApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        cancelRemittance(requestParameters: PayoutApiCancelRemittanceRequest, options?: RawAxiosRequestConfig): AxiosPromise<CancelledRemittanceResponseDTO> {
            return localVarFp.cancelRemittance(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.systemReferenceNumber, requestParameters.walletHashId, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows you to use NIUM’s card widget to tokenize beneficiary card details. Non-PCI DSS compliant Clients are expected to integrate with this new API to get beneficiary’s encrypted card token number. This token number needs to be passed in field encryptedBeneficiaryCardToken while adding a beneficiary to make a payout to card.
         * @summary Get Card Widget
         ...
         * @throws {RequiredError}
         */
        returnMandate(requestParameters: PayoutApiReturnMandateRequest, options?: RawAxiosRequestConfig): AxiosPromise<PayoutApiError2> {
            return localVarFp.returnMandate(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.mandateId, requestParameters.transactionId, requestParameters.walletHashId, requestParameters.updateMandateRequestDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API will allow you to send money to the registered beneficiary.
         * @summary Transfer Money
...
export class PayoutApi extends BaseAPI {
    ...
    public cancelRemittance(requestParameters: PayoutApiCancelRemittanceRequest, options?: RawAxiosRequestConfig) {
        return PayoutApiFp(this.configuration).cancelRemittance(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.systemReferenceNumber, requestParameters.walletHashId, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public returnMandate(requestParameters: PayoutApiReturnMandateRequest, options?: RawAxiosRequestConfig) {
        return PayoutApiFp(this.configuration).returnMandate(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.mandateId, requestParameters.transactionId, requestParameters.walletHashId, requestParameters.updateMandateRequestDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
