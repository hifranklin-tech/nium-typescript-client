...
export const CustomerAccountIndividualApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        unifiedAddCustomer: async (clientHashId: string, addCustomerRequestDTO: AddCustomerRequestDTO, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            ...
            assertParamExists('unifiedAddCustomer', 'addCustomerRequestDTO', addCustomerRequestDTO)
...
export const CustomerAccountIndividualApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async unifiedAddCustomer(clientHashId: string, addCustomerRequestDTO: AddCustomerRequestDTO, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AddCustomerResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.unifiedAddCustomer(clientHashId, addCustomerRequestDTO, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
...
export const CustomerAccountIndividualApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        unifiedAddCustomer(requestParameters: CustomerAccountIndividualApiUnifiedAddCustomerRequest, options?: RawAxiosRequestConfig): AxiosPromise<AddCustomerResponseDTO> {
            return localVarFp.unifiedAddCustomer(requestParameters.clientHashId, requestParameters.addCustomerRequestDTO, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows to upload documents necessary for customer onboarding. Refer to the RFI details on required documents.
         * @summary Upload Document
...
export class CustomerAccountIndividualApi extends BaseAPI {
    ...
    public unifiedAddCustomer(requestParameters: CustomerAccountIndividualApiUnifiedAddCustomerRequest, options?: RawAxiosRequestConfig) {
        return CustomerAccountIndividualApiFp(this.configuration).unifiedAddCustomer(requestParameters.clientHashId, requestParameters.addCustomerRequestDTO, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
