...
// @ts-ignore
import type { P2PTransferDTO } from '../model';
// @ts-ignore
import type { P2PTransferResponse } from '../model';
// @ts-ignore
...
export const WalletToWalletTransfersApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
         * This API enables you to transfer money from one wallet to another wallet within the same client family.   >⚠️ WARNING   >This API version has been deprecated. Eventually, deprecated API versions become unsupported. Use the [Wallet To Wallet Transfer](ref:wallettransfer) API to achieve the same functionality.
         * @summary P2P Transfer
         * @param {string} clientHashId Unique client identifier generated and shared before the API handshake.
...
export interface WalletToWalletTransfersApiP2PTransferRequest {
    /**
     * Unique client identifier generated and shared before the API handshake.
     * @type {string}
