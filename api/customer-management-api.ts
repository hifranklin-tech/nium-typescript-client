...
// @ts-ignore
import type { ViewCustomerFeesResponseDTO } from '../model';
// @ts-ignore
...
export const CustomerManagementApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        accountStatement1: async (clientHashId: string, customerHashId: string, endDate: string, startDate: string, walletHashId: string, currencies?: string, fileType?: string, xRequestId?: string, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'clientHashId' is not null or undefined
            assertParamExists('accountStatement1', 'clientHashId', clientHashId)
            // verify required parameter 'customerHashId' is not null or undefined
            assertParamExists('accountStatement1', 'customerHashId', customerHashId)
            // verify required parameter 'endDate' is not null or undefined
            assertParamExists('accountStatement1', 'endDate', endDate)
            // verify required parameter 'startDate' is not null or undefined
            assertParamExists('accountStatement1', 'startDate', startDate)
            // verify required parameter 'walletHashId' is not null or undefined
            assertParamExists('accountStatement1', 'walletHashId', walletHashId)
...
export const CustomerManagementApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async accountStatement1(clientHashId: string, customerHashId: string, endDate: string, startDate: string, walletHashId: string, currencies?: string, fileType?: string, xRequestId?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ViewCustomerFeesResponseDTO>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountStatement1(clientHashId, customerHashId, endDate, startDate, walletHashId, currencies, fileType, xRequestId, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['CustomerManagementApi.accountStatement1']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * This API allows you to permanently block or temporarily block/unblock a customer.
...
export const CustomerManagementApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * This API allows you to download an account statement.
         * @summary Account Statement for the Specified Wallet
         * @param {CustomerManagementApiAccountStatement1Request} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        accountStatement1(requestParameters: CustomerManagementApiAccountStatement1Request, options?: RawAxiosRequestConfig): AxiosPromise<ViewCustomerFeesResponseDTO> {
            return localVarFp.accountStatement1(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.endDate, requestParameters.startDate, requestParameters.walletHashId, requestParameters.currencies, requestParameters.fileType, requestParameters.xRequestId, options).then((request) => request(axios, basePath));
        },
        /**
         * This API allows you to permanently block or temporarily block/unblock a customer.
         * @summary Block/Unblock Customer
...
/**
 * Request parameters for accountStatement1 operation in CustomerManagementApi.
 * @export
 * @interface CustomerManagementApiAccountStatement1Request
 */
export interface CustomerManagementApiAccountStatement1Request {
    /**
     * Unique client identifier generated and shared before API handshake.
     * @type {string}
     * @memberof CustomerManagementApiAccountStatement1
     */
    readonly clientHashId: string
...
export class CustomerManagementApi extends BaseAPI {
     ...
     * @memberof CustomerManagementApi
     */
    public accountStatement1(requestParameters: CustomerManagementApiAccountStatement1Request, options?: RawAxiosRequestConfig) {
        return CustomerManagementApiFp(this.configuration).accountStatement1(requestParameters.clientHashId, requestParameters.customerHashId, requestParameters.endDate, requestParameters.startDate, requestParameters.walletHashId, requestParameters.currencies, requestParameters.fileType, requestParameters.xRequestId, options).then((request) => request(this.axios, this.basePath));
    }
