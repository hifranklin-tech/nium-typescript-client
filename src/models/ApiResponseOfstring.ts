...
export class ApiResponseOfstring {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "status",
            "baseName": "status",
            "type": "ApiResponseOfstringStatusEnum",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ApiResponseOfstring.attributeTypeMap;
    }
...
export enum ApiResponseOfstringStatusEnum {
