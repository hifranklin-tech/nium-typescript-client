...
export class AddCardRequestVIR {
    /**
    ...
    */
    'cardType': AddCardRequestVIRCardTypeEnum;
    /**
    ...
    */
    'issuanceMode'?: AddCardRequestVIRIssuanceModeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "cardType",
            "baseName": "cardType",
            "type": "AddCardRequestVIRCardTypeEnum",
            "format": ""
        },
        {
            "name": "nameOnCard",
        ...
        },
        {
            ...
            "type": "AddCardRequestVIRIssuanceModeEnum",
            "format": ""
        },
        {
            "name": "plasticId",
    ...
    static getAttributeTypeMap() {
        return AddCardRequestVIR.attributeTypeMap;
    }
...
export enum AddCardRequestVIRCardTypeEnum {
    Phy = 'PHY',
    Vir = 'VIR',
    Virup2Phy = 'VIRUP2PHY'
}
export enum AddCardRequestVIRIssuanceModeEnum {
