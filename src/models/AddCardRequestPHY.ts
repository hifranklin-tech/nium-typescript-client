...
export class AddCardRequestPHY {
    /**
    ...
    */
    'cardType': AddCardRequestPHYCardTypeEnum;
    /**
    ...
    */
    'issuanceMode'?: AddCardRequestPHYIssuanceModeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "cardType",
            "baseName": "cardType",
            "type": "AddCardRequestPHYCardTypeEnum",
            "format": ""
        },
        {
            "name": "nameOnCard",
        ...
        },
        {
            ...
            "type": "AddCardRequestPHYIssuanceModeEnum",
            "format": ""
        },
        {
            "name": "plasticId",
    ...
    static getAttributeTypeMap() {
        return AddCardRequestPHY.attributeTypeMap;
    }
...
export enum AddCardRequestPHYCardTypeEnum {
    Phy = 'PHY',
    Vir = 'VIR',
    Virup2Phy = 'VIRUP2PHY'
}
export enum AddCardRequestPHYIssuanceModeEnum {
