...
export class AddCardRequestVIRUP2PHY {
    /**
    ...
    */
    'cardType': AddCardRequestVIRUP2PHYCardTypeEnum;
    /**
    ...
    */
    'issuanceMode'?: AddCardRequestVIRUP2PHYIssuanceModeEnum;
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        },
        {
            "name": "cardType",
            "baseName": "cardType",
            "type": "AddCardRequestVIRUP2PHYCardTypeEnum",
            "format": ""
        },
        {
            "name": "nameOnCard",
        ...
        },
        {
            ...
            "type": "AddCardRequestVIRUP2PHYIssuanceModeEnum",
            "format": ""
        },
        {
            "name": "plasticId",
    ...
    static getAttributeTypeMap() {
        return AddCardRequestVIRUP2PHY.attributeTypeMap;
    }
...
export enum AddCardRequestVIRUP2PHYCardTypeEnum {
    Phy = 'PHY',
    Vir = 'VIR',
    Virup2Phy = 'VIRUP2PHY'
}
export enum AddCardRequestVIRUP2PHYIssuanceModeEnum {
