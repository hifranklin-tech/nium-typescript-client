# JPFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for JP, Full KYC
...
```typescript
import { JPFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: JPFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
