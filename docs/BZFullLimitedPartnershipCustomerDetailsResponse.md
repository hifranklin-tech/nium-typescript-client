# BZFullLimitedPartnershipCustomerDetailsResponse
...
**applicant** | [**MXFullApplicantDetailsResponse**](MXFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateMXFullCustomerDetailsResponseAllOfStakeholders**](BaseCorporateMXFullCustomerDetailsResponseAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { BZFullLimitedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: BZFullLimitedPartnershipCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
