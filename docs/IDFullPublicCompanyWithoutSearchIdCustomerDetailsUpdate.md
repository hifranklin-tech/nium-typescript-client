# IDFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
