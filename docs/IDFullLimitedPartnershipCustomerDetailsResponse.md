# IDFullLimitedPartnershipCustomerDetailsResponse

Contains customer details for ID, corporate, full kycType and Limited  Partnership businessType
...
```typescript
import { IDFullLimitedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: IDFullLimitedPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
