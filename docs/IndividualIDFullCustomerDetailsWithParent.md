# IndividualIDFullCustomerDetailsWithParent
...
```typescript
import { IndividualIDFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
