# UsApplicantNonResidentManualKycRequest
...
```typescript
import { UsApplicantNonResidentManualKycRequest } from 'nium-client';

const instance: UsApplicantNonResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
