# IndividualSGFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualSGFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
