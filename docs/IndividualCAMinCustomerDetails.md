# IndividualCAMinCustomerDetails

Contains customer details for CA, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualCAMinCustomerDetailsAllOfDocuments&gt;**](IndividualCAMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualCAMinCustomerDetails } from 'nium-client';

const instance: IndividualCAMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
