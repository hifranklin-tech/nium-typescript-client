# CorporateAUMinCustomerDetailsResponse
...
```typescript
import { CorporateAUMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateAUMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
