# CorporateIDMinCustomerDetailsUpdate

Contains update customer details for corporate, ID region, minimum kycType
...
**applicant** | [**IDMinApplicantDetailsUpdate**](IDMinApplicantDetailsUpdate.md) |  | [default to undefined]
...
```typescript
import { CorporateIDMinCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateIDMinCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
