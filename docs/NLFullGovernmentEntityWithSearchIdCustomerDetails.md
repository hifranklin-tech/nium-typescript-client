# NLFullGovernmentEntityWithSearchIdCustomerDetails
...
```typescript
import { NLFullGovernmentEntityWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullGovernmentEntityWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
