# CAFullPrivateCompanyCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Private Company businessType
...
```typescript
import { CAFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: CAFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
