# SGFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
