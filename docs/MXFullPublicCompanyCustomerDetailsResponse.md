# MXFullPublicCompanyCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and Public Company businessType
...
```typescript
import { MXFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: MXFullPublicCompanyCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
