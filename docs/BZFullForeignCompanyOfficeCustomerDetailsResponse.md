# BZFullForeignCompanyOfficeCustomerDetailsResponse

Contains customer details for BZ, corporate, full kycType and Trust businessType
...
```typescript
import { BZFullForeignCompanyOfficeCustomerDetailsResponse } from 'nium-client';

const instance: BZFullForeignCompanyOfficeCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
