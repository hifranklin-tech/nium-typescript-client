# EUFullPrivateCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullPrivateCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPrivateCompanyWithSearchIdCustomerDetailsUpdate = {
