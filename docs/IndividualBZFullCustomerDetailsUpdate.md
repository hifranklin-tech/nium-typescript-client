# IndividualBZFullCustomerDetailsUpdate
...
```typescript
import { IndividualBZFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualBZFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
