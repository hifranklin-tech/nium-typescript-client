# HKFullForeignCompanyOfficeCustomerDetails

Contains customer details for HK, corporate, full kycType and Foreign Company Office businessType
...
**applicant** | [**HKFullApplicantDetailsCreate**](HKFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateHKFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateHKFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsHK&gt;**](BusinessDocumentsHK.md) |  | [optional] [default to undefined]

## Example

```typescript
import { HKFullForeignCompanyOfficeCustomerDetails } from 'nium-client';

const instance: HKFullForeignCompanyOfficeCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
