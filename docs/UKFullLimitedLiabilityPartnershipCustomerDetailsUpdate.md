# UKFullLimitedLiabilityPartnershipCustomerDetailsUpdate
...
```typescript
import { UKFullLimitedLiabilityPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipCustomerDetailsUpdate = {
