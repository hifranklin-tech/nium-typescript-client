# IndividualSGMinCustomerDetailsResponse
...
```typescript
import { IndividualSGMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualSGMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
