# BaseCorporateBZFullCustomerDetailsResponse

Contains common customer details response for corporate, BZ region, full kycType
...
```typescript
import { BaseCorporateBZFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateBZFullCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
