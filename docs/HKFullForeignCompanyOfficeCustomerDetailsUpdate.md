# HKFullForeignCompanyOfficeCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Trust businessType
...
```typescript
import { HKFullForeignCompanyOfficeCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullForeignCompanyOfficeCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
