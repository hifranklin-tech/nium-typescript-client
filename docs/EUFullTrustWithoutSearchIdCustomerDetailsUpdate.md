# EUFullTrustWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullTrustWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullTrustWithoutSearchIdCustomerDetailsUpdate = {
