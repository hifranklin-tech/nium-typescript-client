# BZFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { BZFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
