# MXMinCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for MX, minimum KYC
...
```typescript
import { MXMinCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: MXMinCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
