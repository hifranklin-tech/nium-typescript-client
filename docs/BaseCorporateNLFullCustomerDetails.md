# BaseCorporateNLFullCustomerDetails

Contains common customer details for corporate, NL region, full kycType
...
```typescript
import { BaseCorporateNLFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
