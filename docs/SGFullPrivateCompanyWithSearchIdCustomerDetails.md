# SGFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { SGFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
