# CAFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { CAFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
