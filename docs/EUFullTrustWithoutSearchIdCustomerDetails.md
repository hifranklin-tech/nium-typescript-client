# EUFullTrustWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
