# IDFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
