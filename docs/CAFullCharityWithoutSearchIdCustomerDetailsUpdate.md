# CAFullCharityWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { CAFullCharityWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullCharityWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
