# SGFullTrustCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Trust businessType
...
**addresses** | [**SGTrustCustomerAddresses**](SGTrustCustomerAddresses.md) |  | [default to undefined]
...
**applicant** | [**SGFullApplicantDetailsUpdate**](SGFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateSGFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateSGFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { SGFullTrustCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullTrustCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
