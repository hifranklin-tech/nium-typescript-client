# JPFullApplicantDetailsResponse

Applicant Response Details for JP, full KYC
...
```typescript
import { JPFullApplicantDetailsResponse } from 'nium-client';

const instance: JPFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
