# EUFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { EUFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPrivateCompanyCustomerDetailsUpdate = {
