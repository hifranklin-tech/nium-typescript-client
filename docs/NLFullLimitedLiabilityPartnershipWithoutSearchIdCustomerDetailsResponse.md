# NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
