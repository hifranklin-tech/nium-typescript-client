# BaseIndividualEUFullCustomerDetails

Contains customer details for EU, Individual and full kycType
...
```typescript
import { BaseIndividualEUFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualEUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
