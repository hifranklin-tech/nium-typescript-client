# CorporateBZMinCustomerDetailsCreate

Contains create customer details for corporate, BZ region, minimum kycType
...
**applicant** | [**BZMinApplicantDetails**](BZMinApplicantDetails.md) |  | [default to undefined]
**stakeholders** | [**CorporateBZMinCustomerDetailsCreateAllOfStakeholders**](CorporateBZMinCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateBZMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateBZMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
