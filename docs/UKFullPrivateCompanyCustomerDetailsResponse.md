# UKFullPrivateCompanyCustomerDetailsResponse
...
```typescript
import { UKFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: UKFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
