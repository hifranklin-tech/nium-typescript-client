# UKFullUnincorporatedPartnershipCustomerDetailsResponse
...
```typescript
import { UKFullUnincorporatedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
