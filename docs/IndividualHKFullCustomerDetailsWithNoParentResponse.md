# IndividualHKFullCustomerDetailsWithNoParentResponse
...
```typescript
import { IndividualHKFullCustomerDetailsWithNoParentResponse } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithNoParentResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
