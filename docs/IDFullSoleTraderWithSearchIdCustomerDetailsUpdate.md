# IDFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
