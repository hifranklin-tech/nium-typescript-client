# IndividualIDFullCustomerDetailsUpdate
...
```typescript
import { IndividualIDFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
