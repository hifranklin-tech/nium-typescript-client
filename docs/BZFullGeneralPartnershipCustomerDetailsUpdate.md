# BZFullGeneralPartnershipCustomerDetailsUpdate

Contains customer details for BZ, corporate, full kycType and Association businessType
...
```typescript
import { BZFullGeneralPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullGeneralPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
