# IDMinApplicantDetailsUpdate

Applicant Update Details for ID, minimum KYC
...
```typescript
import { IDMinApplicantDetailsUpdate } from 'nium-client';

const instance: IDMinApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
