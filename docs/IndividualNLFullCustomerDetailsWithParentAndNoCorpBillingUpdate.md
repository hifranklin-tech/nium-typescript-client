# IndividualNLFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualNLFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
