# IndividualAUFullCustomerDetailsWithParentAndCorpBilling
...
```typescript
import { IndividualAUFullCustomerDetailsWithParentAndCorpBilling } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithParentAndCorpBilling = {
    type,
    kycType,
    region,
    externalId,
