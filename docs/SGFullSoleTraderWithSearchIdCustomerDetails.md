# SGFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { SGFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
