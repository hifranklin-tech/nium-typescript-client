# UKFullPrivateCompanyCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Private Company businessType
...
```typescript
import { UKFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPrivateCompanyCustomerDetailsUpdate = {
