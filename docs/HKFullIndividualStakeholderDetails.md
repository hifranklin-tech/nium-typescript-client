# HKFullIndividualStakeholderDetails

Individual Stakeholder Details for HK region, Full KYC
...
```typescript
import { HKFullIndividualStakeholderDetails } from 'nium-client';

const instance: HKFullIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
