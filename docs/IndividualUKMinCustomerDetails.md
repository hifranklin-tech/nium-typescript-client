# IndividualUKMinCustomerDetails

Contains customer details for UK, Individual and minimum kycType
...
**incomeSourceType** | **string** | Nature of the customer’s primary work or business category, such as gig_worker, contractor, freelancer, salaried employee, small business owner etc. | [default to undefined]
**annualIncome** | **string** | The customer’s total estimated income for a year | [default to undefined]
...
**documents** | [**Array&lt;IndividualUKMinCustomerDetailsAllOfDocuments&gt;**](IndividualUKMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualUKMinCustomerDetails } from 'nium-client';

const instance: IndividualUKMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
