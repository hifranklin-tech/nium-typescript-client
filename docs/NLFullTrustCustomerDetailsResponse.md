# NLFullTrustCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Trust businessType
...
```typescript
import { NLFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: NLFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
