# CAFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for CA, Full KYC
...
```typescript
import { CAFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: CAFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
