# IndividualJPFullCustomerDetailsWithParentAndCorpBillingResponse
...
```typescript
import { IndividualJPFullCustomerDetailsWithParentAndCorpBillingResponse } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParentAndCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
