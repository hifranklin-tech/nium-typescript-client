# USFullLimitedPartnershipCustomerDetailsResponse
...
```typescript
import { USFullLimitedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: USFullLimitedPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
