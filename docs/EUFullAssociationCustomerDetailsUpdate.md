# EUFullAssociationCustomerDetailsUpdate
...
```typescript
import { EUFullAssociationCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullAssociationCustomerDetailsUpdate = {
