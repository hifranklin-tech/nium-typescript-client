# UKFullOthersWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullOthersWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullOthersWithoutSearchIdCustomerDetailsUpdate = {
