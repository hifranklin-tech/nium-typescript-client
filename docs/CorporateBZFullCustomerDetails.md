# CorporateBZFullCustomerDetails

Contains customer details for BZ, Corporate and full kycType
...
```typescript
import { CorporateBZFullCustomerDetails } from 'nium-client';

const instance: CorporateBZFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
