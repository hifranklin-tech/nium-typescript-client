# IndividualBZFullCustomerDetailsWithParent
...
```typescript
import { IndividualBZFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualBZFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
