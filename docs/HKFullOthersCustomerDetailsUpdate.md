# HKFullOthersCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Others businessType
...
```typescript
import { HKFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullOthersCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
