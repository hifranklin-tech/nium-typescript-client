# SGFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for SG, Full KYC
...
```typescript
import { SGFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: SGFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
