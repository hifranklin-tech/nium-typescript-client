# BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
