# CorporateUSMinCustomerDetailsCreate

Contains create customer details for corporate, US region, minimum kycType
...
```typescript
import { CorporateUSMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateUSMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
