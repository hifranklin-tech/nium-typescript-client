# CAFullWidelyHeldTrustWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullWidelyHeldTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullWidelyHeldTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
