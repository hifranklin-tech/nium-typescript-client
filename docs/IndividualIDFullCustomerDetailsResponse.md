# IndividualIDFullCustomerDetailsResponse
...
```typescript
import { IndividualIDFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
