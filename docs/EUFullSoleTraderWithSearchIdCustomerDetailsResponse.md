# EUFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
