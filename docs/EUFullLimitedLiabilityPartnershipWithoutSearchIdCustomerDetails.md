# EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
