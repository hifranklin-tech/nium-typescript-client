# NLFullSoleTraderCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Sole Trader businessType
...
```typescript
import { NLFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: NLFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
