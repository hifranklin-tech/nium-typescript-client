# HKFullLimitedPartnershipCustomerDetails
...
```typescript
import { HKFullLimitedPartnershipCustomerDetails } from 'nium-client';

const instance: HKFullLimitedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
