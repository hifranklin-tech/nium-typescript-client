# AUFullGovernmentEntityCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Government Entity businessType
...
```typescript
import { AUFullGovernmentEntityCustomerDetailsResponse } from 'nium-client';

const instance: AUFullGovernmentEntityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
