# USFullCorporationCustomerDetailsUpdate
...
```typescript
import { USFullCorporationCustomerDetailsUpdate } from 'nium-client';

const instance: USFullCorporationCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
