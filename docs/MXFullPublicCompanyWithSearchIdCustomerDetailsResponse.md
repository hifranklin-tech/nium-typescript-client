# MXFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
