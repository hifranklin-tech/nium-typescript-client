# NLFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { NLFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
