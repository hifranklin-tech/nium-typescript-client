# EUFullAssociationWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullAssociationWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullAssociationWithoutSearchIdCustomerDetailsUpdate = {
