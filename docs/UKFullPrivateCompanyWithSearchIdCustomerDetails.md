# UKFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { UKFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
