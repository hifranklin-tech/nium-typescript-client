# MXFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
