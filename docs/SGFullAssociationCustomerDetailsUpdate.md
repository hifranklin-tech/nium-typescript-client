# SGFullAssociationCustomerDetailsUpdate
...
```typescript
import { SGFullAssociationCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullAssociationCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
