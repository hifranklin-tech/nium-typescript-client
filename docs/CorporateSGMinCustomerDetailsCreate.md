# CorporateSGMinCustomerDetailsCreate

Contains create customer details for corporate, SG region, minimum kycType
...
```typescript
import { CorporateSGMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateSGMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
