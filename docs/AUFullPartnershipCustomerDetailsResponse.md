# AUFullPartnershipCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Partnership businessType
...
**businessRegistrationNumber** | **string** | official registration number - must be exactly 11 alphanumeric characters for Partnership | [default to undefined]
...
```typescript
import { AUFullPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: AUFullPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
