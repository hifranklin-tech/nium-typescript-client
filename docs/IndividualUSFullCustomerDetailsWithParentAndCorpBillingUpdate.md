# IndividualUSFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualUSFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithParentAndCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
