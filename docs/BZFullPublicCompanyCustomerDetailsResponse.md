# BZFullPublicCompanyCustomerDetailsResponse

Contains customer details for BZ, corporate, full kycType and Public Company businessType
...
```typescript
import { BZFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: BZFullPublicCompanyCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
