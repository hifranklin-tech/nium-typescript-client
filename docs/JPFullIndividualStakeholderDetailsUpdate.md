# JPFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for JP, Full KYC
...
```typescript
import { JPFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: JPFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
