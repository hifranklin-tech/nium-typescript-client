# CorporateMXMinCustomerDetailsResponse
...
```typescript
import { CorporateMXMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateMXMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
