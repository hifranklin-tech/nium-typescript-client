# HKFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for HK, Full KYC
...
```typescript
import { HKFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: HKFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
