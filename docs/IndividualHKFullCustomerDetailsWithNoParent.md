# IndividualHKFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualHKFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
