# BaseCorporateHKFullCustomerDetailsResponse

Contains common customer details response for corporate, HK region, full kycType
...
```typescript
import { BaseCorporateHKFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateHKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
