# HKFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for HK, Full KYC
...
```typescript
import { HKFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: HKFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
