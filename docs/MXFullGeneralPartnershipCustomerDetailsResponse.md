# MXFullGeneralPartnershipCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and General Partnership businessType
...
```typescript
import { MXFullGeneralPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: MXFullGeneralPartnershipCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
