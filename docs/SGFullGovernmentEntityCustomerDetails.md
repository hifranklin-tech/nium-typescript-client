# SGFullGovernmentEntityCustomerDetails
...
```typescript
import { SGFullGovernmentEntityCustomerDetails } from 'nium-client';

const instance: SGFullGovernmentEntityCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
