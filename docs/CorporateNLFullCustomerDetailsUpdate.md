# CorporateNLFullCustomerDetailsUpdate

Contains update customer details for NL, Corporate and full kycType
...
```typescript
import { CorporateNLFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateNLFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
