# UKFullGovernmentEntityWithSearchIdCustomerDetailsResponse
...
```typescript
import { UKFullGovernmentEntityWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: UKFullGovernmentEntityWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
