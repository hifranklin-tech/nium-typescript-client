# IDFullLimitedPartnershipCustomerDetailsUpdate
...
```typescript
import { IDFullLimitedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullLimitedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
