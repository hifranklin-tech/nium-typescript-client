# CAFullPartnershipCustomerDetailsUpdate
...
```typescript
import { CAFullPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
