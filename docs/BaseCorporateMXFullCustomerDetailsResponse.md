# BaseCorporateMXFullCustomerDetailsResponse

Contains common customer details response for corporate, MX region, full kycType
...
```typescript
import { BaseCorporateMXFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateMXFullCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
