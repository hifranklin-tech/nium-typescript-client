# SGFullPublicCompanyCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Public Company businessType
...
```typescript
import { SGFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
