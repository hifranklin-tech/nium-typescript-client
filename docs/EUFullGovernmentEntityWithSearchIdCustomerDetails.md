# EUFullGovernmentEntityWithSearchIdCustomerDetails
...
```typescript
import { EUFullGovernmentEntityWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullGovernmentEntityWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
