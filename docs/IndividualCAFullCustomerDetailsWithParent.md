# IndividualCAFullCustomerDetailsWithParent
...
```typescript
import { IndividualCAFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
