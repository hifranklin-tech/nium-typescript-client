# SGFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
