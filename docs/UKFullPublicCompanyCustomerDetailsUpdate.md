# UKFullPublicCompanyCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Public Company businessType
...
```typescript
import { UKFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPublicCompanyCustomerDetailsUpdate = {
