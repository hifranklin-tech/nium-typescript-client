# HKFullApplicantDetailsResponse

Applicant Response Details for HK, full KYC
...
```typescript
import { HKFullApplicantDetailsResponse } from 'nium-client';

const instance: HKFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
