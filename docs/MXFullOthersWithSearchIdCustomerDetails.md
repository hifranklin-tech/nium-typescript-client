# MXFullOthersWithSearchIdCustomerDetails
...
```typescript
import { MXFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: MXFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
