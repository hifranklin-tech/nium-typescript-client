# EUFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { EUFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
