# SGFullGovernmentEntityWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullGovernmentEntityWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullGovernmentEntityWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
