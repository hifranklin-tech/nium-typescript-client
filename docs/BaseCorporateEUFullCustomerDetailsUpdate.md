# BaseCorporateEUFullCustomerDetailsUpdate

Contains common update customer details for corporate, EU region, full kycType
...
```typescript
import { BaseCorporateEUFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateEUFullCustomerDetailsUpdate = {
