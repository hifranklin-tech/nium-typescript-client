# IndividualSGFullCustomerDetailsWithParentAndCorpBillingResponse
...
```typescript
import { IndividualSGFullCustomerDetailsWithParentAndCorpBillingResponse } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithParentAndCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
