# CorporateMXFullCustomerDetailsResponse
...
```typescript
import { CorporateMXFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateMXFullCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
