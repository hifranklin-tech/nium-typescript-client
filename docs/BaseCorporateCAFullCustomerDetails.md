# BaseCorporateCAFullCustomerDetails

Contains common customer details for corporate, CA region, full kycType
...
```typescript
import { BaseCorporateCAFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateCAFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
