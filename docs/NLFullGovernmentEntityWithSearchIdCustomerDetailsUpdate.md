# NLFullGovernmentEntityWithSearchIdCustomerDetailsUpdate
...
```typescript
import { NLFullGovernmentEntityWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullGovernmentEntityWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
