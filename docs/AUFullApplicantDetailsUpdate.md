# AUFullApplicantDetailsUpdate

Applicant Update Details for AU, full KYC
...
```typescript
import { AUFullApplicantDetailsUpdate } from 'nium-client';

const instance: AUFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
