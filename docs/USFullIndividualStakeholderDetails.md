# USFullIndividualStakeholderDetails

Individual Stakeholder Details for US region, Full KYC
...
```typescript
import { USFullIndividualStakeholderDetails } from 'nium-client';

const instance: USFullIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
