# BaseCorporateSGFullCustomerDetails

Contains common customer details for corporate, SG region, full kycType
...
```typescript
import { BaseCorporateSGFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateSGFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
