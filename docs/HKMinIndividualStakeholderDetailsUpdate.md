# HKMinIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for HK, minimum KYC
...
**documents** | [**Array&lt;HKMinIndividualStakeholderDetailsAllOfDocuments&gt;**](HKMinIndividualStakeholderDetailsAllOfDocuments.md) |  | [optional] [default to undefined]
...
```typescript
import { HKMinIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: HKMinIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
