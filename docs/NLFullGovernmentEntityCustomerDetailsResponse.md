# NLFullGovernmentEntityCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Government Entity businessType
...
```typescript
import { NLFullGovernmentEntityCustomerDetailsResponse } from 'nium-client';

const instance: NLFullGovernmentEntityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
