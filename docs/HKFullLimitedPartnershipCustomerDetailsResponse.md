# HKFullLimitedPartnershipCustomerDetailsResponse
...
```typescript
import { HKFullLimitedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: HKFullLimitedPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
