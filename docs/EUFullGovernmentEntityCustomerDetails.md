# EUFullGovernmentEntityCustomerDetails
...
```typescript
import { EUFullGovernmentEntityCustomerDetails } from 'nium-client';

const instance: EUFullGovernmentEntityCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
