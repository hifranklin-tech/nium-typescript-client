# EUFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { EUFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPublicCompanyCustomerDetailsUpdate = {
