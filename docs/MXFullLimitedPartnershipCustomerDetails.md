# MXFullLimitedPartnershipCustomerDetails
...
```typescript
import { MXFullLimitedPartnershipCustomerDetails } from 'nium-client';

const instance: MXFullLimitedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
