# UKFullGovernmentEntityWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullGovernmentEntityWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullGovernmentEntityWithSearchIdCustomerDetailsUpdate = {
