# CorporateHKFullCustomerDetailsResponse

Contains customer details response for HK, Corporate and full kycType
...
```typescript
import { CorporateHKFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateHKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
