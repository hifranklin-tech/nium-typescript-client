# MXFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { MXFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: MXFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
