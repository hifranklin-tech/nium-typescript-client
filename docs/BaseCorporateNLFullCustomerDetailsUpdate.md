# BaseCorporateNLFullCustomerDetailsUpdate

Contains common update customer details for corporate, NL region, full kycType
...
```typescript
import { BaseCorporateNLFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
