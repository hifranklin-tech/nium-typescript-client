# MXFullLimitedPartnershipCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and Limited  Partnership businessType
...
```typescript
import { MXFullLimitedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: MXFullLimitedPartnershipCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
