# IndividualCAFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualCAFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
