# IDFullOthersCustomerDetailsUpdate

Contains customer details for ID, corporate, full kycType and Others businessType
...
```typescript
import { IDFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullOthersCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
