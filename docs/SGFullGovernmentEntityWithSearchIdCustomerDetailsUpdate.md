# SGFullGovernmentEntityWithSearchIdCustomerDetailsUpdate
...
```typescript
import { SGFullGovernmentEntityWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullGovernmentEntityWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
