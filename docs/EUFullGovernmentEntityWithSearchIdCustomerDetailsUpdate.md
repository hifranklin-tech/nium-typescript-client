# EUFullGovernmentEntityWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullGovernmentEntityWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullGovernmentEntityWithSearchIdCustomerDetailsUpdate = {
