# BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate
...
```typescript
import { BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
