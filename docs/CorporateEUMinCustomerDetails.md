# CorporateEUMinCustomerDetails

Contains customer details for EU, corporate and minimum kycType
...
```typescript
import { CorporateEUMinCustomerDetails } from 'nium-client';

const instance: CorporateEUMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
