# CAFullWidelyHeldTrustCustomerDetails
...
**applicant** | [**CAFullApplicantDetailsCreate**](CAFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateCAFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateCAFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { CAFullWidelyHeldTrustCustomerDetails } from 'nium-client';

const instance: CAFullWidelyHeldTrustCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
