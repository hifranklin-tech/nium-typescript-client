# MXFullLimitedPartnershipWithSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullLimitedPartnershipWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullLimitedPartnershipWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
