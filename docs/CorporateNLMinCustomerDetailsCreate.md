# CorporateNLMinCustomerDetailsCreate

Contains create customer details for corporate, NL region, minimum kycType
...
```typescript
import { CorporateNLMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateNLMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
