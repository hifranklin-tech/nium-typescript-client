# JPFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { JPFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: JPFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
