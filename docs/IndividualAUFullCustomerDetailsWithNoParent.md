# IndividualAUFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualAUFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
