# NLFullGovernmentEntityWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullGovernmentEntityWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullGovernmentEntityWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
