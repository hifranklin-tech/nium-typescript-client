# IndividualBZMinCustomerDetails

Contains customer details for BZ, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualBZMinCustomerDetailsAllOfDocuments&gt;**](IndividualBZMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualBZMinCustomerDetails } from 'nium-client';

const instance: IndividualBZMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
