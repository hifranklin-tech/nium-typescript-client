# CorporateJPFullCustomerDetailsResponse

Contains customer details response for JP, Corporate and full kycType
...
```typescript
import { CorporateJPFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateJPFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
