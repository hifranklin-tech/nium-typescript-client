# IDMinIndividualStakeholderDetails
...
**documents** | [**Array&lt;IDMinIndividualStakeholderDetailsAllOfDocuments&gt;**](IDMinIndividualStakeholderDetailsAllOfDocuments.md) |  | [optional] [default to undefined]
**positions** | [**Array&lt;PositionDetailsDTO&gt;**](PositionDetailsDTO.md) |  | [default to undefined]

## Example

```typescript
import { IDMinIndividualStakeholderDetails } from 'nium-client';

const instance: IDMinIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
