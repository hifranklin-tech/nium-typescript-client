# CAFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for CA, Full KYC
...
```typescript
import { CAFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: CAFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
