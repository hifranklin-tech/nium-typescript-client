# EUFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for EU, Full KYC
...
```typescript
import { EUFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: EUFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
