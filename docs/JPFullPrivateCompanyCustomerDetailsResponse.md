# JPFullPrivateCompanyCustomerDetailsResponse

Contains customer details for JP, corporate, full kycType and Private Company businessType
...
**applicant** | [**JPFullApplicantDetailsResponse**](JPFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**JPFullApplicantAndStakeholderDetailsResponseStakeholders**](JPFullApplicantAndStakeholderDetailsResponseStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { JPFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: JPFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
