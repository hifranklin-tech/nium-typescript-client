# IndividualJPFullCustomerDetailsWithParent
...
```typescript
import { IndividualJPFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
