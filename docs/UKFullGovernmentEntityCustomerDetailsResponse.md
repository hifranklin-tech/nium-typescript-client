# UKFullGovernmentEntityCustomerDetailsResponse
...
```typescript
import { UKFullGovernmentEntityCustomerDetailsResponse } from 'nium-client';

const instance: UKFullGovernmentEntityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
