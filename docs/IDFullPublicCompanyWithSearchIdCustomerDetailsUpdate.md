# IDFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
