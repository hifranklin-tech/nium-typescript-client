# BaseCorporateHKFullCustomerDetailsUpdate

Contains common update customer details for corporate, HK region, full kycType
...
```typescript
import { BaseCorporateHKFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateHKFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
