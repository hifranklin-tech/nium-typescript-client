# BaseIndividualHKFullCustomerDetails

Contains customer details for HK, Individual and full kycType
...
```typescript
import { BaseIndividualHKFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualHKFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
