# USFullCorporationCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and Corporation businessType
...
```typescript
import { USFullCorporationCustomerDetailsResponse } from 'nium-client';

const instance: USFullCorporationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
