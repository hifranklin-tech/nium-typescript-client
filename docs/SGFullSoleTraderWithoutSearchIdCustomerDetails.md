# SGFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
