# BaseIndividualBZFullCustomerDetails

Contains customer details for BZ, Individual and full kycType
...
```typescript
import { BaseIndividualBZFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualBZFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
