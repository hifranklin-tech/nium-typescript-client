# MXFullForeignCompanyOfficeCustomerDetails

Contains customer details for MX, corporate, full kycType and Foreign Company Office businessType
...
**applicant** | [**MXFullApplicantDetailsCreate**](MXFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateMXFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateMXFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsMX&gt;**](BusinessDocumentsMX.md) |  | [optional] [default to undefined]

## Example

```typescript
import { MXFullForeignCompanyOfficeCustomerDetails } from 'nium-client';

const instance: MXFullForeignCompanyOfficeCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
