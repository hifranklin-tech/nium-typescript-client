# NLFullApplicantDetailsUpdate

Applicant Update Details for NL, full KYC
...
```typescript
import { NLFullApplicantDetailsUpdate } from 'nium-client';

const instance: NLFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
