# USFullUnincorporatedPartnershipCustomerDetailsUpdate
...
```typescript
import { USFullUnincorporatedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: USFullUnincorporatedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
