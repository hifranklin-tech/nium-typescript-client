# NLFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
