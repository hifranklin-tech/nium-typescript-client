# SGFullAssociationCustomerDetailsResponse
...
```typescript
import { SGFullAssociationCustomerDetailsResponse } from 'nium-client';

const instance: SGFullAssociationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
