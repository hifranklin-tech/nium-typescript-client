# NLFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { NLFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: NLFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
