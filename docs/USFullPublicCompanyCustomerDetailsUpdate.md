# USFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { USFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: USFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
