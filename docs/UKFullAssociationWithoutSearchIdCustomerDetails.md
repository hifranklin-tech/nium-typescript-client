# UKFullAssociationWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullAssociationWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullAssociationWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
