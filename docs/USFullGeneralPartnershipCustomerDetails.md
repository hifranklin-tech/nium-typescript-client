# USFullGeneralPartnershipCustomerDetails
...
```typescript
import { USFullGeneralPartnershipCustomerDetails } from 'nium-client';

const instance: USFullGeneralPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
