# BaseCorporateBZFullCustomerDetailsAllOfExpectedAccountUsage
...
**credit** | [**BaseCorporateAUFullCustomerDetailsAllOfExpectedAccountUsageCredit**](BaseCorporateAUFullCustomerDetailsAllOfExpectedAccountUsageCredit.md) |  | [default to undefined]
...
```typescript
import { BaseCorporateBZFullCustomerDetailsAllOfExpectedAccountUsage } from 'nium-client';

const instance: BaseCorporateBZFullCustomerDetailsAllOfExpectedAccountUsage = {
    intendedUses,
