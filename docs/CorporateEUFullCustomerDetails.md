# CorporateEUFullCustomerDetails

Contains customer details for EU, Corporate and full kycType
...
```typescript
import { CorporateEUFullCustomerDetails } from 'nium-client';

const instance: CorporateEUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
