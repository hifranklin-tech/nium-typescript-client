# MXFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { MXFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
