# SGFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for SG, Full KYC
...
**positions** | [**Array&lt;SGPositionDetails&gt;**](SGPositionDetails.md) |  | [default to undefined]
...
```typescript
import { SGFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: SGFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
