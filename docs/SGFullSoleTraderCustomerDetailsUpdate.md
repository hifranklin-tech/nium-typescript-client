# SGFullSoleTraderCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Sole Trader businessType
...
```typescript
import { SGFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
