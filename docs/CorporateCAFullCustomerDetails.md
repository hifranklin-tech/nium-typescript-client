# CorporateCAFullCustomerDetails

Contains customer details for CA, Corporate and full kycType
...
```typescript
import { CorporateCAFullCustomerDetails } from 'nium-client';

const instance: CorporateCAFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
