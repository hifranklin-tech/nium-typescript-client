# BZFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for BZ, Full KYC
...
```typescript
import { BZFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: BZFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
