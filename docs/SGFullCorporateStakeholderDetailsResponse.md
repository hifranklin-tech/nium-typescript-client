# SGFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for SG, Full KYC
...
```typescript
import { SGFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: SGFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
