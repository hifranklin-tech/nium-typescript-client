# MXFullForeignCompanyOfficeCustomerDetailsUpdate
...
**applicant** | [**MXFullApplicantDetailsUpdate**](MXFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateMXFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateMXFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { MXFullForeignCompanyOfficeCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullForeignCompanyOfficeCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
