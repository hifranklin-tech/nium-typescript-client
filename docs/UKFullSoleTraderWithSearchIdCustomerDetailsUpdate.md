# UKFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
