# UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate = {
