# UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
