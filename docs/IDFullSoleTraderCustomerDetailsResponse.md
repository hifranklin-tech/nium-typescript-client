# IDFullSoleTraderCustomerDetailsResponse

Contains customer details for ID, corporate, full kycType and Sole Trader businessType
...
```typescript
import { IDFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: IDFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
