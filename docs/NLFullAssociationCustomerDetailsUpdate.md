# NLFullAssociationCustomerDetailsUpdate
...
```typescript
import { NLFullAssociationCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullAssociationCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
