# AUFullUnRegulatedTrustCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Unregulated Trust businessType
...
```typescript
import { AUFullUnRegulatedTrustCustomerDetailsResponse } from 'nium-client';

const instance: AUFullUnRegulatedTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
