# MXMinIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for MX, minimum KYC
...
**documents** | [**Array&lt;MXMinIndividualStakeholderDetailsAllOfDocuments&gt;**](MXMinIndividualStakeholderDetailsAllOfDocuments.md) |  | [optional] [default to undefined]
...
```typescript
import { MXMinIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: MXMinIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
