# SGFullGovernmentEntityCustomerDetailsResponse
...
```typescript
import { SGFullGovernmentEntityCustomerDetailsResponse } from 'nium-client';

const instance: SGFullGovernmentEntityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
