# HKFullPrivateCompanyCustomerDetailsResponse
...
```typescript
import { HKFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: HKFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
