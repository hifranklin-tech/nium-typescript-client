# BZFullApplicantDetailsResponse

Applicant Response Details for BZ, full KYC
...
```typescript
import { BZFullApplicantDetailsResponse } from 'nium-client';

const instance: BZFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
