# IndividualEUFullCustomerDetailsWithParent
...
```typescript
import { IndividualEUFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
