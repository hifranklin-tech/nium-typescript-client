# SGFullAssociationWithSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullAssociationWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullAssociationWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
