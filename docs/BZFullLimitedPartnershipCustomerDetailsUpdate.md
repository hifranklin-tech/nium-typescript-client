# BZFullLimitedPartnershipCustomerDetailsUpdate

Contains customer details for BZ, corporate, full kycType and Limited Partnership businessType
...
**applicant** | [**BZFullApplicantDetailsUpdate**](BZFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateBZFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateBZFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { BZFullLimitedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullLimitedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
