# IndividualCAFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualCAFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
