# IDFullPrivateLimitedCompanyCustomerDetailsResponse

Contains customer details for ID, corporate, full kycType and Private Limited Company businessType
...
```typescript
import { IDFullPrivateLimitedCompanyCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
