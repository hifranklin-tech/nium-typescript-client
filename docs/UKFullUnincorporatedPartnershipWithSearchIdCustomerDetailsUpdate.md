# UKFullUnincorporatedPartnershipWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullUnincorporatedPartnershipWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipWithSearchIdCustomerDetailsUpdate = {
