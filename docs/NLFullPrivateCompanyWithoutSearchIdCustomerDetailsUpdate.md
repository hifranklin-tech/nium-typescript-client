# NLFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { NLFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
