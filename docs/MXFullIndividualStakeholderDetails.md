# MXFullIndividualStakeholderDetails

Individual Stakeholder Details for MX region, Full KYC
...
```typescript
import { MXFullIndividualStakeholderDetails } from 'nium-client';

const instance: MXFullIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
