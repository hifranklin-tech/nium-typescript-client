# HKFullPrivateCompanyCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Private Company businessType
...
```typescript
import { HKFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
