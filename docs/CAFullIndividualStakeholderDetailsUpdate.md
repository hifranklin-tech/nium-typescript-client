# CAFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for CA, Full KYC
...
```typescript
import { CAFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: CAFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
