# BaseCorporateBZFullCustomerDetailsUpdate

Contains common update customer details for corporate, BZ region, full kycType
...
```typescript
import { BaseCorporateBZFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateBZFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
