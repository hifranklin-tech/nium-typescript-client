# UKFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
