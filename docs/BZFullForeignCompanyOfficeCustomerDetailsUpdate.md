# BZFullForeignCompanyOfficeCustomerDetailsUpdate
...
```typescript
import { BZFullForeignCompanyOfficeCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullForeignCompanyOfficeCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
