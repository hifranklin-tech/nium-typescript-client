# CorporateMXMinCustomerDetails

Contains customer details for MX, corporate and minimum kycType
...
```typescript
import { CorporateMXMinCustomerDetails } from 'nium-client';

const instance: CorporateMXMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
