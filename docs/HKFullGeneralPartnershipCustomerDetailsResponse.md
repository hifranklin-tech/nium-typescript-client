# HKFullGeneralPartnershipCustomerDetailsResponse
...
```typescript
import { HKFullGeneralPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: HKFullGeneralPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
