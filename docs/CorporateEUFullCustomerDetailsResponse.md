# CorporateEUFullCustomerDetailsResponse

Contains customer details response for EU, Corporate and full kycType
...
```typescript
import { CorporateEUFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateEUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
