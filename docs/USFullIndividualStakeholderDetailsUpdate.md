# USFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for US, Full KYC
...
```typescript
import { USFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: USFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
