# BZFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { BZFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: BZFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
