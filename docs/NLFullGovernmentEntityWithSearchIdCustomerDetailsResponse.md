# NLFullGovernmentEntityWithSearchIdCustomerDetailsResponse
...
```typescript
import { NLFullGovernmentEntityWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: NLFullGovernmentEntityWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
