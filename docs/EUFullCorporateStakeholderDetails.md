# EUFullCorporateStakeholderDetails

Corporate Stakeholder Details for EU region, Full KYC
...
```typescript
import { EUFullCorporateStakeholderDetails } from 'nium-client';

const instance: EUFullCorporateStakeholderDetails = {
    externalId,
    businessName,
