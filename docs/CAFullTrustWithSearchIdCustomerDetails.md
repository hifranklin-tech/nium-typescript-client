# CAFullTrustWithSearchIdCustomerDetails
...
```typescript
import { CAFullTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
