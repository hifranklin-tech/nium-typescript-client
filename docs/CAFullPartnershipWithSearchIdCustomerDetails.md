# CAFullPartnershipWithSearchIdCustomerDetails
...
```typescript
import { CAFullPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
