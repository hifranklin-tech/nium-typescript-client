# BaseCorporateAUFullCustomerDetailsCreate

Contains common create customer details for corporate, AU region, full kycType
...
```typescript
import { BaseCorporateAUFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateAUFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
