# IndividualJPFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualJPFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
