# CorporateIDFullCustomerDetailsUpdate

Contains update customer details for ID, Corporate and full kycType
...
```typescript
import { CorporateIDFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateIDFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
