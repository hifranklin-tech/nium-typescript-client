# CAFullTrustWithSearchIdCustomerDetailsResponse
...
```typescript
import { CAFullTrustWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: CAFullTrustWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
