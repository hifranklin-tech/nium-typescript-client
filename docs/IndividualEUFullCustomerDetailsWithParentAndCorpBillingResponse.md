# IndividualEUFullCustomerDetailsWithParentAndCorpBillingResponse
...
```typescript
import { IndividualEUFullCustomerDetailsWithParentAndCorpBillingResponse } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParentAndCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
