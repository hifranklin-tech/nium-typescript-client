# IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
