# SGFullGovernmentEntityCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Government Entity businessType
...
```typescript
import { SGFullGovernmentEntityCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullGovernmentEntityCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
