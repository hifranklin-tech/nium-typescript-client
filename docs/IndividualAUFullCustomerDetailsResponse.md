# IndividualAUFullCustomerDetailsResponse
...
```typescript
import { IndividualAUFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
