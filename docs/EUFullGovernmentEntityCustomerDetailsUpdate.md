# EUFullGovernmentEntityCustomerDetailsUpdate
...
```typescript
import { EUFullGovernmentEntityCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullGovernmentEntityCustomerDetailsUpdate = {
