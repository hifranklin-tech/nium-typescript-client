# BaseCorporateMXFullCustomerDetailsCreate

Contains common create customer details for corporate, MX region, full kycType
...
```typescript
import { BaseCorporateMXFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateMXFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
