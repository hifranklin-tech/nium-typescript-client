# CAFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { CAFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
