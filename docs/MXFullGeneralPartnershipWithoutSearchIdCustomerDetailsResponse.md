# MXFullGeneralPartnershipWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullGeneralPartnershipWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullGeneralPartnershipWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
