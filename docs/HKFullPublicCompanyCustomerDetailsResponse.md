# HKFullPublicCompanyCustomerDetailsResponse
...
```typescript
import { HKFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: HKFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
