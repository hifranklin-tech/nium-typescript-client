# MXFullSoleTraderWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullSoleTraderWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullSoleTraderWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
