# CorporateMXFullCustomerDetailsUpdate

Contains update customer details for MX, Corporate and full kycType
...
```typescript
import { CorporateMXFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateMXFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
