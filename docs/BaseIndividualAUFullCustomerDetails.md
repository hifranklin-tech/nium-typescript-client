# BaseIndividualAUFullCustomerDetails

Contains customer details for AU, Individual and full kycType
...
```typescript
import { BaseIndividualAUFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualAUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
