# IndividualCAFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualCAFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
