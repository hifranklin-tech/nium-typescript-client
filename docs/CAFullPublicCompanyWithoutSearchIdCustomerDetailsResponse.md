# CAFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { CAFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: CAFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
