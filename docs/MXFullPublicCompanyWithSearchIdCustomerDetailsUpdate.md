# MXFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { MXFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
