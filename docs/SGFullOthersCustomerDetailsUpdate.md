# SGFullOthersCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Others businessType
...
```typescript
import { SGFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullOthersCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
