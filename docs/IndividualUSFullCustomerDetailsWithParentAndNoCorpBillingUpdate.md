# IndividualUSFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualUSFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
