# NLFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { NLFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
