# MXFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
