# NLFullGovernmentEntityCustomerDetailsUpdate
...
```typescript
import { NLFullGovernmentEntityCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullGovernmentEntityCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
