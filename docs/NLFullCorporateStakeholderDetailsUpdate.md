# NLFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for NL, Full KYC
...
```typescript
import { NLFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: NLFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
