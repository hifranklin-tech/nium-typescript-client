# IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingResponse
...
```typescript
import { IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingResponse } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
