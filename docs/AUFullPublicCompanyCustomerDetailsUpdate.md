# AUFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { AUFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
