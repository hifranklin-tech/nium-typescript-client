# IndividualUKFullCustomerDetailsResponse
...
```typescript
import { IndividualUKFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
