# EUFullTrustWithSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullTrustWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullTrustWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
