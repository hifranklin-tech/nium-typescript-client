# IndividualNLMinCustomerDetailsResponse
...
```typescript
import { IndividualNLMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualNLMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
