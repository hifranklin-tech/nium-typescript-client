# UKFullOthersWithSearchIdCustomerDetails
...
```typescript
import { UKFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
