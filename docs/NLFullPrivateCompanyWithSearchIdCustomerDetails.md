# NLFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { NLFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
