# IDFullSoleTraderWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullSoleTraderWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullSoleTraderWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
