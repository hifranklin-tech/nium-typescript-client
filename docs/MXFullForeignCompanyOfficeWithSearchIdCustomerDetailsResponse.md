# MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
