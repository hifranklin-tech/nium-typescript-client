# CorporateMXMinCustomerDetailsUpdate

Contains update customer details for corporate, MX region, minimum kycType
...
**applicant** | [**MXMinApplicantDetailsUpdate**](MXMinApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**CorporateMXMinCustomerDetailsUpdateAllOfStakeholders**](CorporateMXMinCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateMXMinCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateMXMinCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
