# UKFullApplicantDetailsUpdate

Applicant Update Details for UK, full KYC
...
```typescript
import { UKFullApplicantDetailsUpdate } from 'nium-client';

const instance: UKFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
