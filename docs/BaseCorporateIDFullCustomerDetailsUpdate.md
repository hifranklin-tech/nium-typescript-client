# BaseCorporateIDFullCustomerDetailsUpdate

Contains common update customer details for corporate, ID region, full kycType
...
```typescript
import { BaseCorporateIDFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateIDFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
