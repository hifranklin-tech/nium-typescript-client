# HKFullSoleTraderCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Sole Trader businessType
...
```typescript
import { HKFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
