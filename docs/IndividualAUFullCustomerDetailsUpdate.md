# IndividualAUFullCustomerDetailsUpdate
...
```typescript
import { IndividualAUFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
