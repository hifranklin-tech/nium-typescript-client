# UKFullOthersWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullOthersWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullOthersWithSearchIdCustomerDetailsUpdate = {
