# HKMinCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for HK, minimum KYC
...
```typescript
import { HKMinCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: HKMinCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
