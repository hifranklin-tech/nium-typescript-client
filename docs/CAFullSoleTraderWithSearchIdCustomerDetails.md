# CAFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { CAFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
