...
**customerHashId** | **string** | Customer hash identifier | [default to undefined]
**authCode** | **string** | Authorization code for transaction RFI | [default to undefined]
**walletHashId** | **string** | Wallet hash identifier | [default to undefined]
**externalScaReferenceId** | **string** | External SCA reference identifier (required for EU/UK regions) | [optional] [default to undefined]

## Example

```typescript
import { NformifySessionRequest } from 'nium-client';

const instance: NformifySessionRequest = {
    featureType,
    clientHashId,
    expiry,
