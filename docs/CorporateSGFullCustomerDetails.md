# CorporateSGFullCustomerDetails

Contains customer details for SG, Corporate and full kycType
...
```typescript
import { CorporateSGFullCustomerDetails } from 'nium-client';

const instance: CorporateSGFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
