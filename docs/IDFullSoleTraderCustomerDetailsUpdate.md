# IDFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { IDFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
