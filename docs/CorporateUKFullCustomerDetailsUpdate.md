# CorporateUKFullCustomerDetailsUpdate

Contains update customer details for UK, Individual and full kycType
...
```typescript
import { CorporateUKFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateUKFullCustomerDetailsUpdate = {
