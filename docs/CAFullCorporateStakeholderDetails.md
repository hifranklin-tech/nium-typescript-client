# CAFullCorporateStakeholderDetails

Corporate Stakeholder Details for CA region, Full KYC
...
```typescript
import { CAFullCorporateStakeholderDetails } from 'nium-client';

const instance: CAFullCorporateStakeholderDetails = {
    externalId,
    businessName,
