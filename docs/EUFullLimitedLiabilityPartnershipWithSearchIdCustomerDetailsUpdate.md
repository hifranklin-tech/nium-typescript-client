# EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate = {
