# MXFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
