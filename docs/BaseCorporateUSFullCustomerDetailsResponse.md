# BaseCorporateUSFullCustomerDetailsResponse

Contains common customer details response for corporate, US region, full kycType
...
```typescript
import { BaseCorporateUSFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateUSFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
