# UsIndividualStakeholderNonResidentManualKycRequest
...
```typescript
import { UsIndividualStakeholderNonResidentManualKycRequest } from 'nium-client';

const instance: UsIndividualStakeholderNonResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
