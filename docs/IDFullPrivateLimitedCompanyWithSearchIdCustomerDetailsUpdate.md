# IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
