# BaseIndividualJPFullCustomerDetails

Contains customer details for JP, Individual and full kycType
...
```typescript
import { BaseIndividualJPFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualJPFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
