# USFullEstateCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and Estate businessType
...
```typescript
import { USFullEstateCustomerDetailsResponse } from 'nium-client';

const instance: USFullEstateCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
