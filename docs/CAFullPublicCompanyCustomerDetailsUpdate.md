# CAFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { CAFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
