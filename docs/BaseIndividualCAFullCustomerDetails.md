# BaseIndividualCAFullCustomerDetails

Contains customer details for CA, Individual and full kycType
...
```typescript
import { BaseIndividualCAFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualCAFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
