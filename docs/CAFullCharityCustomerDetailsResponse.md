# CAFullCharityCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Charity businessType
...
```typescript
import { CAFullCharityCustomerDetailsResponse } from 'nium-client';

const instance: CAFullCharityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
