# IndividualCAFullCustomerDetailsWithParentAndCorpBillingResponse
...
```typescript
import { IndividualCAFullCustomerDetailsWithParentAndCorpBillingResponse } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParentAndCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
