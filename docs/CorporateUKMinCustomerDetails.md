# CorporateUKMinCustomerDetails

Contains customer details for UK, corporate and minimum kycType
...
```typescript
import { CorporateUKMinCustomerDetails } from 'nium-client';

const instance: CorporateUKMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
