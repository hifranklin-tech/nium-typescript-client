# BZFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { BZFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: BZFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
