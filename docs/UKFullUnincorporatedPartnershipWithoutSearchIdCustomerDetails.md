# UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
