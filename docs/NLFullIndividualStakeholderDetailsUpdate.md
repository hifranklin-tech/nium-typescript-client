# NLFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for NL, Full KYC
...
```typescript
import { NLFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: NLFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
