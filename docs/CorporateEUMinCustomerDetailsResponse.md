# CorporateEUMinCustomerDetailsResponse
...
```typescript
import { CorporateEUMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateEUMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
