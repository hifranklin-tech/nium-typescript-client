# BaseCorporateJPFullCustomerDetailsUpdate

Contains common update customer details for corporate, JP region, full kycType
...
```typescript
import { BaseCorporateJPFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateJPFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
