# MXFullSoleTraderWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { MXFullSoleTraderWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullSoleTraderWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
