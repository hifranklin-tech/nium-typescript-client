# CAFullTrustCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Trust businessType
...
```typescript
import { CAFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: CAFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
