# HKFullOthersWithSearchIdCustomerDetails
...
```typescript
import { HKFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: HKFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
