# USFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for US, Full KYC
...
**positions** | [**Array&lt;USPositionDetails&gt;**](USPositionDetails.md) |  | [default to undefined]
...
```typescript
import { USFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: USFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
