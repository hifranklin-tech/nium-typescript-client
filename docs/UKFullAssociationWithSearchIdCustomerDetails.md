# UKFullAssociationWithSearchIdCustomerDetails
...
```typescript
import { UKFullAssociationWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullAssociationWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
