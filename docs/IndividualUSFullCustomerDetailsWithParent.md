# IndividualUSFullCustomerDetailsWithParent
...
```typescript
import { IndividualUSFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
