# NLFullAssociationWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullAssociationWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullAssociationWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
