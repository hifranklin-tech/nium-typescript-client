# IndividualUSMinCustomerDetails

Contains customer details for US, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualUSMinCustomerDetailsAllOfDocuments&gt;**](IndividualUSMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualUSMinCustomerDetails } from 'nium-client';

const instance: IndividualUSMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
