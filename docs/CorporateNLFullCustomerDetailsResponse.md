# CorporateNLFullCustomerDetailsResponse

Contains customer details response for NL, Corporate and full kycType
...
```typescript
import { CorporateNLFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateNLFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
