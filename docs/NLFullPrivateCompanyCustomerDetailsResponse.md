# NLFullPrivateCompanyCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Private Company businessType
...
```typescript
import { NLFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: NLFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
