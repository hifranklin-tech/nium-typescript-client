# EUFullTrustWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullTrustWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullTrustWithSearchIdCustomerDetailsUpdate = {
