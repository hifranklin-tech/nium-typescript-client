# HKFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for HK, Full KYC
...
```typescript
import { HKFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: HKFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
