# SGFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
