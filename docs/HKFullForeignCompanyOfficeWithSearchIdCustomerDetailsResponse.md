# HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
