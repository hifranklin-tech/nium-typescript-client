# UKFullTrustWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullTrustWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullTrustWithSearchIdCustomerDetailsUpdate = {
