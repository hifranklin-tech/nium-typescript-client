# UKFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate = {
