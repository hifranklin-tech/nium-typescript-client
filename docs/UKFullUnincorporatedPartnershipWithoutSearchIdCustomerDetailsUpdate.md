# UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipWithoutSearchIdCustomerDetailsUpdate = {
