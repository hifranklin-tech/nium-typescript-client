# MXFullApplicantDetailsResponse

Applicant Response Details for MX, full KYC
...
```typescript
import { MXFullApplicantDetailsResponse } from 'nium-client';

const instance: MXFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
