# CAFullApplicantDetailsCreate

Applicant create Details for CA region, Full KYC
...
```typescript
import { CAFullApplicantDetailsCreate } from 'nium-client';

const instance: CAFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
