# IDFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { IDFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
