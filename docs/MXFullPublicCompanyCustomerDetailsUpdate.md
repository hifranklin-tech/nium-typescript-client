# MXFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { MXFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
