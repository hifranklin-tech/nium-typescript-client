# BaseCorporateHKFullCustomerDetails

Contains common customer details for corporate, HK region, full kycType
...
```typescript
import { BaseCorporateHKFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateHKFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
