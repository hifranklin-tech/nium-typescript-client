# SGFullAssociationWithSearchIdCustomerDetails
...
```typescript
import { SGFullAssociationWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullAssociationWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
