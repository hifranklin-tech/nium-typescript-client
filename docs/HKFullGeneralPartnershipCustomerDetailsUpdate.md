# HKFullGeneralPartnershipCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Association businessType
...
```typescript
import { HKFullGeneralPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullGeneralPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
