# CorporateAUMinCustomerDetails

Contains customer details for AU, corporate and minimum kycType
...
```typescript
import { CorporateAUMinCustomerDetails } from 'nium-client';

const instance: CorporateAUMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
