# IndividualUKFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualUKFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
