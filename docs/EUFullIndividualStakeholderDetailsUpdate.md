# EUFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for EU, Full KYC
...
```typescript
import { EUFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: EUFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
