# IndividualNLFullCustomerDetailsWithParentResponse
...
```typescript
import { IndividualNLFullCustomerDetailsWithParentResponse } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithParentResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
