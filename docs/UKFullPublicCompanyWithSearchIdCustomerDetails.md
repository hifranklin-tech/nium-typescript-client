# UKFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { UKFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
