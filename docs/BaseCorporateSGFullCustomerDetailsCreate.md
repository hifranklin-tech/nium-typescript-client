# BaseCorporateSGFullCustomerDetailsCreate

Contains common create customer details for corporate, SG region, full kycType
...
```typescript
import { BaseCorporateSGFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateSGFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
