# EUFullPrivateCompanyCustomerDetailsResponse

Contains customer details for EU, corporate, full kycType and Private Company businessType
...
```typescript
import { EUFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: EUFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
