# IndividualMXFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualMXFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualMXFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
