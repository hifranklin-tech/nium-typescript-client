# USFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { USFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: USFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
