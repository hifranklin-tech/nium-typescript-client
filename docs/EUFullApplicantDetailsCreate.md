# EUFullApplicantDetailsCreate

Applicant create Details for EU region, Full KYC
...
```typescript
import { EUFullApplicantDetailsCreate } from 'nium-client';

const instance: EUFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
