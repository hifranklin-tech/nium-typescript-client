# EUFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { EUFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullSoleTraderCustomerDetailsUpdate = {
