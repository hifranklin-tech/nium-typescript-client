# AUFullRegulatedTrustCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Regulated Trust businessType
...
**businessRegistrationNumber** | **string** | official registration number - must be exactly 11 alphanumeric characters for Regulated Trust | [default to undefined]
...
**applicant** | [**AUFullApplicantDetailsResponse**](AUFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateAUFullCustomerDetailsResponseAllOfStakeholders**](BaseCorporateAUFullCustomerDetailsResponseAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { AUFullRegulatedTrustCustomerDetailsResponse } from 'nium-client';

const instance: AUFullRegulatedTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
