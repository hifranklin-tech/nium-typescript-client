# IndividualJPMinCustomerDetailsResponse
...
```typescript
import { IndividualJPMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualJPMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
