# JPFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { JPFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: JPFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
