# IndividualIDFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualIDFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
