# UKFullUnincorporatedPartnershipWithSearchIdCustomerDetails
...
```typescript
import { UKFullUnincorporatedPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
