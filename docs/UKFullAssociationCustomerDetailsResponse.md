# UKFullAssociationCustomerDetailsResponse
...
```typescript
import { UKFullAssociationCustomerDetailsResponse } from 'nium-client';

const instance: UKFullAssociationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
