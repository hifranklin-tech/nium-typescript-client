# BaseCorporateCAFullCustomerDetailsCreate

Contains common create customer details for corporate, CA region, full kycType
...
```typescript
import { BaseCorporateCAFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateCAFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
