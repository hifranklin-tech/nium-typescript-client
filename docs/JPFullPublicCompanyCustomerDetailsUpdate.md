# JPFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { JPFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: JPFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
