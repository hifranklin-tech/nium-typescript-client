# IndividualHKFullCustomerDetailsWithParent
...
```typescript
import { IndividualHKFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
