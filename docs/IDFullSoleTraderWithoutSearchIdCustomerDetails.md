# IDFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { IDFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
