# IndividualJPFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualJPFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParentAndCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
