# HKFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for HK, Full KYC
...
```typescript
import { HKFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: HKFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
