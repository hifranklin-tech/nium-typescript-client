# NLFullLimitedLiabilityPartnershipCustomerDetails
...
**applicant** | [**NLFullApplicantDetailsCreate**](NLFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateNLFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateNLFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { NLFullLimitedLiabilityPartnershipCustomerDetails } from 'nium-client';

const instance: NLFullLimitedLiabilityPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
