# JPFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { JPFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: JPFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
