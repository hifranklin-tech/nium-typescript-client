# MXFullSoleTraderCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and Sole Trader businessType
...
```typescript
import { MXFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: MXFullSoleTraderCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
