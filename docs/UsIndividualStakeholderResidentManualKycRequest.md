# UsIndividualStakeholderResidentManualKycRequest
...
**proofOfIdentityDocument** | [**Array&lt;ProofOfIdentityResidentManual&gt;**](ProofOfIdentityResidentManual.md) |  | [default to undefined]

## Example

```typescript
import { UsIndividualStakeholderResidentManualKycRequest } from 'nium-client';

const instance: UsIndividualStakeholderResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
