# BaseCorporateNLFullCustomerDetailsCreate

Contains common create customer details for corporate, NL region, full kycType
...
```typescript
import { BaseCorporateNLFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
