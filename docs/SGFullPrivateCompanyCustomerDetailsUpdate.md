# SGFullPrivateCompanyCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Private Company businessType
...
```typescript
import { SGFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
