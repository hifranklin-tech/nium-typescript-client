# UKFullAssociationWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullAssociationWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullAssociationWithSearchIdCustomerDetailsUpdate = {
