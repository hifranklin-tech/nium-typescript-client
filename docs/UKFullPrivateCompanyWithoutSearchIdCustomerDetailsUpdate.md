# UKFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate = {
