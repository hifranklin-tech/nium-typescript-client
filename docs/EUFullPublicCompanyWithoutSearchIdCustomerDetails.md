# EUFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
