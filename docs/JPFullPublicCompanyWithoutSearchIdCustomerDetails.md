# JPFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { JPFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: JPFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
