# EUFullAssociationWithSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullAssociationWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullAssociationWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
