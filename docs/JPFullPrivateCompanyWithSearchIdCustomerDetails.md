# JPFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { JPFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: JPFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
