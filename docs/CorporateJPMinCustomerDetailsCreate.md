# CorporateJPMinCustomerDetailsCreate

Contains create customer details for corporate, JP region, minimum kycType
...
```typescript
import { CorporateJPMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateJPMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
