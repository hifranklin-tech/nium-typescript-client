# BZFullPrivateCompanyCustomerDetailsResponse

Contains customer details for BZ, corporate, full kycType and Private Company businessType
...
```typescript
import { BZFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: BZFullPrivateCompanyCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
