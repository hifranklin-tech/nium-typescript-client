# CAFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { CAFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
