# USFullPublicCompanyCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and Public Company businessType
...
```typescript
import { USFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: USFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
