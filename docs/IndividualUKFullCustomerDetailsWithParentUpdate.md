# IndividualUKFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualUKFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithParentUpdate = {
