# EUFullApplicantDetailsResponse

Applicant Response Details for EU, full KYC
...
```typescript
import { EUFullApplicantDetailsResponse } from 'nium-client';

const instance: EUFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
