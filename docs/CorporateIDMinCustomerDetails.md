# CorporateIDMinCustomerDetails

Contains customer details for ID, corporate and minimum kycType
...
```typescript
import { CorporateIDMinCustomerDetails } from 'nium-client';

const instance: CorporateIDMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
