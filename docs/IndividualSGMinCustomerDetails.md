# IndividualSGMinCustomerDetails

Contains customer details for SG, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualSGMinCustomerDetailsAllOfDocuments&gt;**](IndividualSGMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualSGMinCustomerDetails } from 'nium-client';

const instance: IndividualSGMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
