# UKFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for UK, Full KYC
...
```typescript
import { UKFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: UKFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
