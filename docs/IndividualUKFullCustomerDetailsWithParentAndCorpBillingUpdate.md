# IndividualUKFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualUKFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithParentAndCorpBillingUpdate = {
