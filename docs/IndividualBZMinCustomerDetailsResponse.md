# IndividualBZMinCustomerDetailsResponse
...
```typescript
import { IndividualBZMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualBZMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
