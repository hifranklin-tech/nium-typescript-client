# BaseCorporateCAFullCustomerDetailsResponse

Contains common customer details response for corporate, CA region, full kycType
...
```typescript
import { BaseCorporateCAFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateCAFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
