# CAFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { CAFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
