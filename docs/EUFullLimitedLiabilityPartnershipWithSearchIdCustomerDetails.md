# EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails
...
```typescript
import { EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
