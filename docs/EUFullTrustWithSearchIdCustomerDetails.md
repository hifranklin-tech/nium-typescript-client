# EUFullTrustWithSearchIdCustomerDetails
...
```typescript
import { EUFullTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
