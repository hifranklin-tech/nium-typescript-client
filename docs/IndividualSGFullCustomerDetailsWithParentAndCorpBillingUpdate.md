# IndividualSGFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualSGFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithParentAndCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
