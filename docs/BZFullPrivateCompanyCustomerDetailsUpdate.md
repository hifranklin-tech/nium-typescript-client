# BZFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { BZFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
