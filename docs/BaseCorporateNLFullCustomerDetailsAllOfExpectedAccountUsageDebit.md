# BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageDebit
...
**topBeneficiaries** | **Array&lt;string&gt;** | Array of expected primary beneficiaries. Can be specific companies or types of entities | [optional] [default to undefined]

## Example

```typescript
import { BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageDebit } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageDebit = {
