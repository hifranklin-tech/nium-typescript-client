# UKFullGovernmentEntityWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullGovernmentEntityWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullGovernmentEntityWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
