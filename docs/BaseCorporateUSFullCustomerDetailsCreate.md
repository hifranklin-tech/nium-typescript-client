# BaseCorporateUSFullCustomerDetailsCreate

Contains common create customer details for corporate, US region, full kycType
...
```typescript
import { BaseCorporateUSFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateUSFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
