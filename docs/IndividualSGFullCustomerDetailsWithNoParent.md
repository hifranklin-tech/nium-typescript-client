# IndividualSGFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualSGFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
