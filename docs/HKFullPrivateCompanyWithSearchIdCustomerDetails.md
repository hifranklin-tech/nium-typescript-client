# HKFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { HKFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: HKFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
