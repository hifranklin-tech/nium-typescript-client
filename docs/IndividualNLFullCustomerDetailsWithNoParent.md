# IndividualNLFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualNLFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
