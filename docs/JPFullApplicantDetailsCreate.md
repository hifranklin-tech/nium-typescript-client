# JPFullApplicantDetailsCreate

Applicant create Details for JP region, Full KYC
...
```typescript
import { JPFullApplicantDetailsCreate } from 'nium-client';

const instance: JPFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
