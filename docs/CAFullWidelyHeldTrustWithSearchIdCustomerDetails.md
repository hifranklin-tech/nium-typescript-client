# CAFullWidelyHeldTrustWithSearchIdCustomerDetails
...
```typescript
import { CAFullWidelyHeldTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullWidelyHeldTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
