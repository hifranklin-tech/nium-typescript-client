# BZFullIndividualStakeholderDetails

Individual Stakeholder Details for BZ region, Full KYC
...
```typescript
import { BZFullIndividualStakeholderDetails } from 'nium-client';

const instance: BZFullIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
