# EUFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
