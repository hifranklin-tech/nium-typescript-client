# IndividualNLMinCustomerDetails

Contains customer details for NL, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualNLMinCustomerDetailsAllOfDocuments&gt;**](IndividualNLMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualNLMinCustomerDetails } from 'nium-client';

const instance: IndividualNLMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
