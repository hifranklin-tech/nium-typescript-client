# IDFullSoleTraderWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullSoleTraderWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullSoleTraderWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
