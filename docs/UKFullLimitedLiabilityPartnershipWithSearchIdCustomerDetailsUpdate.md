# UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetailsUpdate = {
