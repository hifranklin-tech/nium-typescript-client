# UKFullTrustWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
