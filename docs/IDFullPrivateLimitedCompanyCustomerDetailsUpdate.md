# IDFullPrivateLimitedCompanyCustomerDetailsUpdate
...
```typescript
import { IDFullPrivateLimitedCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
