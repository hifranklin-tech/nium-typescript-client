# IndividualJPFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualJPFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
