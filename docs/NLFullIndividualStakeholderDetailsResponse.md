# NLFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for NL, Full KYC
...
**positions** | [**Array&lt;NLPositionDetails&gt;**](NLPositionDetails.md) |  | [default to undefined]
...
```typescript
import { NLFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: NLFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
