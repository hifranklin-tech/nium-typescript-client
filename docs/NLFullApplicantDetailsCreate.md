# NLFullApplicantDetailsCreate

Applicant create Details for NL region, Full KYC
...
```typescript
import { NLFullApplicantDetailsCreate } from 'nium-client';

const instance: NLFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
