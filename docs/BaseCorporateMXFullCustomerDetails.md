# BaseCorporateMXFullCustomerDetails

Contains common customer details for corporate, MX region, full kycType
...
```typescript
import { BaseCorporateMXFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateMXFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
