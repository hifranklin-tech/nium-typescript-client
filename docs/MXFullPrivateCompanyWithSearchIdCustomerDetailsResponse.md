# MXFullPrivateCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { MXFullPrivateCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: MXFullPrivateCompanyWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
