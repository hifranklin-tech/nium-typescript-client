# UsIndividualCustomerResidentEKycRequest
...
```typescript
import { UsIndividualCustomerResidentEKycRequest } from 'nium-client';

const instance: UsIndividualCustomerResidentEKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
