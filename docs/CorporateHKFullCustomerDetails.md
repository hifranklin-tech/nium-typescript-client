# CorporateHKFullCustomerDetails

Contains customer details for HK, Corporate and full kycType
...
```typescript
import { CorporateHKFullCustomerDetails } from 'nium-client';

const instance: CorporateHKFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
