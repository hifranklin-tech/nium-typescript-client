# NLFullCorporateStakeholderDetails

Corporate Stakeholder Details for NL region, Full KYC
...
```typescript
import { NLFullCorporateStakeholderDetails } from 'nium-client';

const instance: NLFullCorporateStakeholderDetails = {
    externalId,
    businessName,
