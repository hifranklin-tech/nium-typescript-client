# BaseCorporateBZFullCustomerDetails

Contains common customer details for corporate, BZ region, full kycType
...
```typescript
import { BaseCorporateBZFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateBZFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
