# SGFullTrustWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
