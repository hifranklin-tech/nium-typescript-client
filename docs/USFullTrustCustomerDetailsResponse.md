# USFullTrustCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and Trust businessType
...
```typescript
import { USFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: USFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
