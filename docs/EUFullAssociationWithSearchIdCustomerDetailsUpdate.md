# EUFullAssociationWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullAssociationWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullAssociationWithSearchIdCustomerDetailsUpdate = {
