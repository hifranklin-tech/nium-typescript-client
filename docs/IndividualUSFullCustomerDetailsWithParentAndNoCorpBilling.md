# IndividualUSFullCustomerDetailsWithParentAndNoCorpBilling
...
```typescript
import { IndividualUSFullCustomerDetailsWithParentAndNoCorpBilling } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithParentAndNoCorpBilling = {
    type,
    kycType,
    region,
    externalId,
