# EUFullGovernmentEntityCustomerDetailsResponse

Contains customer details for EU, corporate, full kycType and Government Entity businessType
...
```typescript
import { EUFullGovernmentEntityCustomerDetailsResponse } from 'nium-client';

const instance: EUFullGovernmentEntityCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
