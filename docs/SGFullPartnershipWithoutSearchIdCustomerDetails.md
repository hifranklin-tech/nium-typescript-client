# SGFullPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
