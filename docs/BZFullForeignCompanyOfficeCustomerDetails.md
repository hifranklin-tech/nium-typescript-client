# BZFullForeignCompanyOfficeCustomerDetails

Contains customer details for BZ, corporate, full kycType and Foreign Company Office businessType
...
**applicant** | [**BZFullApplicantDetailsCreate**](BZFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateBZFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateBZFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsBZ&gt;**](BusinessDocumentsBZ.md) |  | [optional] [default to undefined]

## Example

```typescript
import { BZFullForeignCompanyOfficeCustomerDetails } from 'nium-client';

const instance: BZFullForeignCompanyOfficeCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
