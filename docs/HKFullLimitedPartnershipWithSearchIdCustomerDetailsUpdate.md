# HKFullLimitedPartnershipWithSearchIdCustomerDetailsUpdate
...
```typescript
import { HKFullLimitedPartnershipWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullLimitedPartnershipWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
