# CorporateIDFullCustomerDetailsResponse

Contains customer details response for ID, Corporate and full kycType
...
```typescript
import { CorporateIDFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateIDFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
