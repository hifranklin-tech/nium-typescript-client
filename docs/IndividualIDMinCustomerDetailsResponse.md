# IndividualIDMinCustomerDetailsResponse
...
```typescript
import { IndividualIDMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualIDMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
