# IndividualEUFullCustomerDetailsUpdate
...
```typescript
import { IndividualEUFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsUpdate = {
