# NLFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
