# NLFullPublicCompanyCustomerDetailsUpdate
...
```typescript
import { NLFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
