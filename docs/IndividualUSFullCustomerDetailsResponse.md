# IndividualUSFullCustomerDetailsResponse
...
```typescript
import { IndividualUSFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
