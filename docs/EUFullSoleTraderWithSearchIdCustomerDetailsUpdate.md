# EUFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
