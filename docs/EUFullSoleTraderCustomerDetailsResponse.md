# EUFullSoleTraderCustomerDetailsResponse

Contains customer details for EU, corporate, full kycType and Sole Trader businessType
...
```typescript
import { EUFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: EUFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
