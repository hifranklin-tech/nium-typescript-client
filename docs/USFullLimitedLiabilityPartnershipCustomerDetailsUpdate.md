# USFullLimitedLiabilityPartnershipCustomerDetailsUpdate
...
**applicant** | [**USFullApplicantDetailsUpdate**](USFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateUSFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateUSFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsUS&gt;**](BusinessDocumentsUS.md) |  | [optional] [default to undefined]

## Example

```typescript
import { USFullLimitedLiabilityPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: USFullLimitedLiabilityPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
