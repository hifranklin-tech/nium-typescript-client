# USFullApplicantDetailsResponse

Applicant Response Details for US, full KYC
...
**positions** | [**Array&lt;USPositionDetails&gt;**](USPositionDetails.md) | Positions held by the applicant in the company. More than one position title can be selected | [default to undefined]
...
```typescript
import { USFullApplicantDetailsResponse } from 'nium-client';

const instance: USFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
