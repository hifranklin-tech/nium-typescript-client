# SGFullTrustWithSearchIdCustomerDetails
...
```typescript
import { SGFullTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
