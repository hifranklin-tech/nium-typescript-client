# IDFullPublicCompanyCustomerDetailsUpdate

Contains customer details for ID, corporate, full kycType and Public Company businessType
...
```typescript
import { IDFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
