# ProofOfIdentityResidentManualWithFiles
...
```typescript
import { ProofOfIdentityResidentManualWithFiles } from 'nium-client';

const instance: ProofOfIdentityResidentManualWithFiles = {
    type,
