# IndividualIDFullCustomerDetailsWithParentAndCorpBillingResponse
...
```typescript
import { IndividualIDFullCustomerDetailsWithParentAndCorpBillingResponse } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsWithParentAndCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
