# BaseCorporateAUFullCustomerDetailsAllOfExpectedAccountUsageCredit
...
```typescript
import { BaseCorporateAUFullCustomerDetailsAllOfExpectedAccountUsageCredit } from 'nium-client';

const instance: BaseCorporateAUFullCustomerDetailsAllOfExpectedAccountUsageCredit = {
