# IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
