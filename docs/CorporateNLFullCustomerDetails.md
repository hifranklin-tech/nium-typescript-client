# CorporateNLFullCustomerDetails

Contains customer details for NL, Corporate and full kycType
...
```typescript
import { CorporateNLFullCustomerDetails } from 'nium-client';

const instance: CorporateNLFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
