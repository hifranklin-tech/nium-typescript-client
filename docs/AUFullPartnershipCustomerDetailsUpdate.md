# AUFullPartnershipCustomerDetailsUpdate
...
```typescript
import { AUFullPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
