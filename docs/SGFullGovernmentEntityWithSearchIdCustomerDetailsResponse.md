# SGFullGovernmentEntityWithSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullGovernmentEntityWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullGovernmentEntityWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
