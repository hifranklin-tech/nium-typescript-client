# IDFullApplicantAndStakeholderDetailsResponse
...
```typescript
import { IDFullApplicantAndStakeholderDetailsResponse } from 'nium-client';

const instance: IDFullApplicantAndStakeholderDetailsResponse = {
    applicant,
    stakeholders,
};
```
