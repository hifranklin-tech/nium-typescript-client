# CAFullSoleTraderCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Sole Trader businessType
...
```typescript
import { CAFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: CAFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
