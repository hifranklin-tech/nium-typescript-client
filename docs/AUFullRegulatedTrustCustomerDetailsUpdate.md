# AUFullRegulatedTrustCustomerDetailsUpdate
...
**applicant** | [**AUFullApplicantDetailsUpdate**](AUFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateAUFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateAUFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { AUFullRegulatedTrustCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullRegulatedTrustCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
