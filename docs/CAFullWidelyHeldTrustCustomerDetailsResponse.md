# CAFullWidelyHeldTrustCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Widely Held Trust businessType
...
**natureOfBusiness** | [**BaseCorporateCAFullCustomerDetailsAllOfNatureOfBusiness**](BaseCorporateCAFullCustomerDetailsAllOfNatureOfBusiness.md) |  | [default to undefined]
**listedExchange** | **string** | Listed exchange of the company if it is publicly listed | [optional] [default to undefined]
...
**applicant** | [**CAFullApplicantDetailsResponse**](CAFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**CAFullApplicantAndStakeholderDetailsResponseStakeholders**](CAFullApplicantAndStakeholderDetailsResponseStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { CAFullWidelyHeldTrustCustomerDetailsResponse } from 'nium-client';

const instance: CAFullWidelyHeldTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
