# HKFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
