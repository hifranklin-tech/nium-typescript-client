# IndividualHKMinCustomerDetailsResponse
...
```typescript
import { IndividualHKMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualHKMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
