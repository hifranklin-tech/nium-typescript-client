# CorporateEUFullCustomerDetailsUpdate

Contains update customer details for EU, Corporate and full kycType
...
```typescript
import { CorporateEUFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateEUFullCustomerDetailsUpdate = {
