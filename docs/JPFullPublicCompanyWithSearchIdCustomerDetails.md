# JPFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { JPFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: JPFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
