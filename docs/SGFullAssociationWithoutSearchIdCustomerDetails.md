# SGFullAssociationWithoutSearchIdCustomerDetails
...
```typescript
import { SGFullAssociationWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullAssociationWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
