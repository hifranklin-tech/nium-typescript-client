# CAFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
