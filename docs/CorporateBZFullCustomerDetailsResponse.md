# CorporateBZFullCustomerDetailsResponse

Contains customer details response for BZ, Corporate and full kycType
...
```typescript
import { CorporateBZFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateBZFullCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
