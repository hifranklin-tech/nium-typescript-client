# IndividualUKFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualUKFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithNoParentUpdate = {
