# SGFullPublicCompanyCustomerDetailsResponse
...
```typescript
import { SGFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: SGFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
