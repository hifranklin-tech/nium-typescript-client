# IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingResponse
...
```typescript
import { IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingResponse } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsWithParentAndNoCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
