# BaseCorporateIDFullCustomerDetails

Contains common customer details for corporate, ID region, full kycType
...
```typescript
import { BaseCorporateIDFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateIDFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
