# MXFullLimitedPartnershipCustomerDetailsUpdate
...
**applicant** | [**HKFullApplicantDetailsUpdate**](HKFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateHKFullCustomerDetailsUpdateAllOfStakeholders**](BaseCorporateHKFullCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { MXFullLimitedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullLimitedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
