# BaseCorporateAUFullCustomerDetails

Contains common customer details for corporate, AU region, full kycType
...
```typescript
import { BaseCorporateAUFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateAUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
