# CorporateJPFullCustomerDetailsUpdate

Contains update customer details for JP, Corporate and full kycType
...
```typescript
import { CorporateJPFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateJPFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
