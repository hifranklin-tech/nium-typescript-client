# IndividualUKFullCustomerDetailsUpdate
...
```typescript
import { IndividualUKFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsUpdate = {
