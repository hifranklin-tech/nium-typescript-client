# IDFullLimitedPartnershipCustomerDetails
...
```typescript
import { IDFullLimitedPartnershipCustomerDetails } from 'nium-client';

const instance: IDFullLimitedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
