# IndividualMXFullCustomerDetailsUpdate
...
```typescript
import { IndividualMXFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualMXFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
