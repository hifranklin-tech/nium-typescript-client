# BZFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { BZFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: BZFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
