# NLFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { NLFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: NLFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
