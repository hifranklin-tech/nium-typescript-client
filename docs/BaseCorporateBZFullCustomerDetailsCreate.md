# BaseCorporateBZFullCustomerDetailsCreate

Contains common create customer details for corporate, BZ region, full kycType
...
```typescript
import { BaseCorporateBZFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateBZFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
