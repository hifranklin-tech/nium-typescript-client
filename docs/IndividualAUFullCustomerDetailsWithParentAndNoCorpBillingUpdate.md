# IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
