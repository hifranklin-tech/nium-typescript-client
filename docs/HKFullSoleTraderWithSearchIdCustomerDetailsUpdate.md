# HKFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { HKFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
