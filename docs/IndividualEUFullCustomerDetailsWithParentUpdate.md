# IndividualEUFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualEUFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParentUpdate = {
