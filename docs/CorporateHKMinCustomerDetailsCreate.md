# CorporateHKMinCustomerDetailsCreate

Contains create customer details for corporate, HK region, minimum kycType
...
**applicant** | [**HKMinApplicantDetails**](HKMinApplicantDetails.md) |  | [default to undefined]
**stakeholders** | [**CorporateHKMinCustomerDetailsCreateAllOfStakeholders**](CorporateHKMinCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateHKMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateHKMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
