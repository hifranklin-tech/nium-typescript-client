# USFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for US, Full KYC
...
```typescript
import { USFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: USFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
