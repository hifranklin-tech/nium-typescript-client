# CorporateCAMinCustomerDetails

Contains customer details for CA, corporate and minimum kycType
...
```typescript
import { CorporateCAMinCustomerDetails } from 'nium-client';

const instance: CorporateCAMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
