# SGFullApplicantDetailsUpdate

Applicant Update Details for SG, full KYC
...
```typescript
import { SGFullApplicantDetailsUpdate } from 'nium-client';

const instance: SGFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
