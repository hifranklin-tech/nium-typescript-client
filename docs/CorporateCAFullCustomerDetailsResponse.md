# CorporateCAFullCustomerDetailsResponse

Contains customer details response for CA, Corporate and full kycType
...
**listedExchange** | **string** | Listed exchange of the company if it is publicly listed | [default to undefined]
...
```typescript
import { CorporateCAFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateCAFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
