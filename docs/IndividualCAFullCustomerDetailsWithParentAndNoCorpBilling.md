# IndividualCAFullCustomerDetailsWithParentAndNoCorpBilling
...
```typescript
import { IndividualCAFullCustomerDetailsWithParentAndNoCorpBilling } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParentAndNoCorpBilling = {
    type,
    kycType,
    region,
    externalId,
