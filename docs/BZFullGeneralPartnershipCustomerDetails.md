# BZFullGeneralPartnershipCustomerDetails
...
```typescript
import { BZFullGeneralPartnershipCustomerDetails } from 'nium-client';

const instance: BZFullGeneralPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
