# USFullSoleTraderCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and Sole Trader businessType
...
```typescript
import { USFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: USFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
