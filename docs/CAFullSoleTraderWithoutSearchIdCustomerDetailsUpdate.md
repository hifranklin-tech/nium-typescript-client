# CAFullSoleTraderWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { CAFullSoleTraderWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullSoleTraderWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
