# UKMinIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for UK, minimum KYC
...
```typescript
import { UKMinIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: UKMinIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
