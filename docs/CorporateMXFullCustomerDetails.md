# CorporateMXFullCustomerDetails

Contains customer details for MX, Corporate and full kycType
...
```typescript
import { CorporateMXFullCustomerDetails } from 'nium-client';

const instance: CorporateMXFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
