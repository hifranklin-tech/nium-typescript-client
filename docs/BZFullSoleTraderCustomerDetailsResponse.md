# BZFullSoleTraderCustomerDetailsResponse

Contains customer details for BZ, corporate, full kycType and Sole Trader businessType
...
```typescript
import { BZFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: BZFullSoleTraderCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
