# IndividualMXFullCustomerDetailsWithParent
...
```typescript
import { IndividualMXFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualMXFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
