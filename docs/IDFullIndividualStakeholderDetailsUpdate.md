# IDFullIndividualStakeholderDetailsUpdate
...
```typescript
import { IDFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: IDFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
