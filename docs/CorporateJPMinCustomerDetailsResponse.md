# CorporateJPMinCustomerDetailsResponse
...
```typescript
import { CorporateJPMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateJPMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
