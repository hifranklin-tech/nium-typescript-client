# AUFullAssociationCustomerDetailsUpdate
...
```typescript
import { AUFullAssociationCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullAssociationCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
