# IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingResponse
...
```typescript
import { IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingResponse } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithParentAndNoCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
