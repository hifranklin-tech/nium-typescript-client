# CorporateSGMinCustomerDetails

Contains customer details for SG, corporate and minimum kycType
...
```typescript
import { CorporateSGMinCustomerDetails } from 'nium-client';

const instance: CorporateSGMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
