# EUFullLimitedLiabilityPartnershipCustomerDetails
...
**applicant** | [**EUFullApplicantDetailsCreate**](EUFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateEUFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateEUFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { EUFullLimitedLiabilityPartnershipCustomerDetails } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
