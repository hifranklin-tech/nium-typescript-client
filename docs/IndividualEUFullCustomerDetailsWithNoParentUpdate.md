# IndividualEUFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualEUFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithNoParentUpdate = {
