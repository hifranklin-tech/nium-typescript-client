# SGFullOthersWithSearchIdCustomerDetails
...
```typescript
import { SGFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
