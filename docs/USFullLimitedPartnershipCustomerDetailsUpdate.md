# USFullLimitedPartnershipCustomerDetailsUpdate
...
```typescript
import { USFullLimitedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: USFullLimitedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
