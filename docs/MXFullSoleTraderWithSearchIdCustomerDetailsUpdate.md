# MXFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { MXFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
