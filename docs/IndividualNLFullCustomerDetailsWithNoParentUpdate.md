# IndividualNLFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualNLFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
