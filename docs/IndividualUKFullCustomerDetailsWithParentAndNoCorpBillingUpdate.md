# IndividualUKFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualUKFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
