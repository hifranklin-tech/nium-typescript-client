# MXFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { MXFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: MXFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
