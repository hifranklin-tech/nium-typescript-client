# IDFullPrivateLimitedCompanyWithSearchIdCustomerDetails
...
```typescript
import { IDFullPrivateLimitedCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
