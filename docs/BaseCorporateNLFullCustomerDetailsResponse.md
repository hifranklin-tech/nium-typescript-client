# BaseCorporateNLFullCustomerDetailsResponse

Contains common customer details response for corporate, NL region, full kycType
...
```typescript
import { BaseCorporateNLFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
