# CorporateBZMinCustomerDetailsUpdate

Contains update customer details for corporate, BZ region, minimum kycType
...
**applicant** | [**BZMinApplicantDetailsUpdate**](BZMinApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**CorporateBZMinCustomerDetailsUpdateAllOfStakeholders**](CorporateBZMinCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateBZMinCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateBZMinCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
