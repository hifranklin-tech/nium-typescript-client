# NLFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { NLFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
