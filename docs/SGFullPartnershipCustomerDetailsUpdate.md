# SGFullPartnershipCustomerDetailsUpdate

Contains customer details for SG, corporate, full kycType and Partnership businessType
...
```typescript
import { SGFullPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
