# CAFullCharityWithSearchIdCustomerDetailsUpdate
...
```typescript
import { CAFullCharityWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullCharityWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
