# SGFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { SGFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
