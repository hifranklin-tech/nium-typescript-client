# UKFullGovernmentEntityWithSearchIdCustomerDetails
...
```typescript
import { UKFullGovernmentEntityWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullGovernmentEntityWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
