# EUFullSoleTraderWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullSoleTraderWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullSoleTraderWithoutSearchIdCustomerDetailsUpdate = {
