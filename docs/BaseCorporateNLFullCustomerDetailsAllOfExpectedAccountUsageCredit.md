# BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageCredit
...
**topRemitters** | **Array&lt;string&gt;** | Array of expected primary remitters. Can be specific companies or types of entities | [optional] [default to undefined]

## Example

```typescript
import { BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageCredit } from 'nium-client';

const instance: BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsageCredit = {
