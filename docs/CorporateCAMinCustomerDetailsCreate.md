# CorporateCAMinCustomerDetailsCreate

Contains create customer details for corporate, CA region, minimum kycType
...
```typescript
import { CorporateCAMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateCAMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
