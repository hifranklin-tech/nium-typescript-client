# IndividualAUFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualAUFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
