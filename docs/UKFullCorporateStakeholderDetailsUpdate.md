# UKFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for UK, Full KYC
...
```typescript
import { UKFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: UKFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
