# HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate
...
```typescript
import { HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
