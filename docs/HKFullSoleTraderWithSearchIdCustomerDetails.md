# HKFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { HKFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: HKFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
