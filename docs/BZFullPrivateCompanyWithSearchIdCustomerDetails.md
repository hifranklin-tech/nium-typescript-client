# BZFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { BZFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: BZFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
