# NLFullGovernmentEntityCustomerDetails
...
```typescript
import { NLFullGovernmentEntityCustomerDetails } from 'nium-client';

const instance: NLFullGovernmentEntityCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
