# SGFullPartnershipWithSearchIdCustomerDetails
...
```typescript
import { SGFullPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
