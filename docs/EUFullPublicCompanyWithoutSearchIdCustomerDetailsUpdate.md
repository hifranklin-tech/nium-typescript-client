# EUFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate = {
