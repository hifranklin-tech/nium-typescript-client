# UKFullGovernmentEntityCustomerDetails
...
```typescript
import { UKFullGovernmentEntityCustomerDetails } from 'nium-client';

const instance: UKFullGovernmentEntityCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
