# BZFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
