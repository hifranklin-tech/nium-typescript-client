# UKFullUnincorporatedPartnershipCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Unincorporated Partnership businessType
...
**applicant** | [**UKFullApplicantDetailsUpdate**](UKFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**UKFullApplicantAndStakeholderDetailsUpdateStakeholders**](UKFullApplicantAndStakeholderDetailsUpdateStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsUK&gt;**](BusinessDocumentsUK.md) |  | [optional] [default to undefined]

## Example

```typescript
import { UKFullUnincorporatedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipCustomerDetailsUpdate = {
