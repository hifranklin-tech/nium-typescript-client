# EUFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for EU, Full KYC
...
```typescript
import { EUFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: EUFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
