# IDFullOthersWithSearchIdCustomerDetails
...
```typescript
import { IDFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
