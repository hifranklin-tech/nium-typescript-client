# CorporateNLMinCustomerDetails

Contains customer details for NL, corporate and minimum kycType
...
```typescript
import { CorporateNLMinCustomerDetails } from 'nium-client';

const instance: CorporateNLMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
