# IDFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
