# IDFullPublicCompanyCustomerDetailsResponse
...
```typescript
import { IDFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
