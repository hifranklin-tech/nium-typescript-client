# BZFullApplicantDetailsCreate

Applicant create Details for BZ region, Full KYC
...
```typescript
import { BZFullApplicantDetailsCreate } from 'nium-client';

const instance: BZFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
