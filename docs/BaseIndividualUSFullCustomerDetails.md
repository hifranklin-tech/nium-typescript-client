# BaseIndividualUSFullCustomerDetails

Contains customer details for US, Individual and full kycType
...
```typescript
import { BaseIndividualUSFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualUSFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
