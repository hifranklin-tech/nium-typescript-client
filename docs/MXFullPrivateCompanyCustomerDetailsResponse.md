# MXFullPrivateCompanyCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and Private Company businessType
...
```typescript
import { MXFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: MXFullPrivateCompanyCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
