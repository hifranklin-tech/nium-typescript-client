# BaseCorporateEUFullCustomerDetails

Contains common customer details for corporate, EU region, full kycType
...
```typescript
import { BaseCorporateEUFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateEUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
