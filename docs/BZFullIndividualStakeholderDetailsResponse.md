# BZFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for BZ, Full KYC
...
```typescript
import { BZFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: BZFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
