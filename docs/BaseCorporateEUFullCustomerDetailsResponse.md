# BaseCorporateEUFullCustomerDetailsResponse

Contains common customer details response for corporate, EU region, full kycType
...
```typescript
import { BaseCorporateEUFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateEUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
