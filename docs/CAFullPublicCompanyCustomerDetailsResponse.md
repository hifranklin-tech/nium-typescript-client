# CAFullPublicCompanyCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Public Company businessType
...
```typescript
import { CAFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: CAFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
