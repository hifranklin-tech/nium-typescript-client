# MXFullGeneralPartnershipCustomerDetailsUpdate

Contains customer details for MX, corporate, full kycType and Association businessType
...
```typescript
import { MXFullGeneralPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullGeneralPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
