# UsIndividualCustomerResidentKycRequest
...
```typescript
import { UsIndividualCustomerResidentKycRequest } from 'nium-client';

const instance: UsIndividualCustomerResidentKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
