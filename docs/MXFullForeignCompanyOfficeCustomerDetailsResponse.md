# MXFullForeignCompanyOfficeCustomerDetailsResponse

Contains customer details for MX, corporate, full kycType and Trust businessType
...
```typescript
import { MXFullForeignCompanyOfficeCustomerDetailsResponse } from 'nium-client';

const instance: MXFullForeignCompanyOfficeCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
