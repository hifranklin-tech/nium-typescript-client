# IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
