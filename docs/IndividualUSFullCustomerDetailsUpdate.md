# IndividualUSFullCustomerDetailsUpdate
...
```typescript
import { IndividualUSFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
