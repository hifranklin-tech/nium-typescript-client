# AUFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { AUFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
