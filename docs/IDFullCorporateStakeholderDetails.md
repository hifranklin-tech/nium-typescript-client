# IDFullCorporateStakeholderDetails

Corporate Stakeholder Details for ID region, Full KYC
...
```typescript
import { IDFullCorporateStakeholderDetails } from 'nium-client';

const instance: IDFullCorporateStakeholderDetails = {
    externalId,
    businessName,
