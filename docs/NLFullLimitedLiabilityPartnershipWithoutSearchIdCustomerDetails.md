# NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
