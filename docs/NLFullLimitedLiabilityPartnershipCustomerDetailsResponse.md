# NLFullLimitedLiabilityPartnershipCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Limited Liability Partnership businessType
...
**natureOfBusiness** | [**BaseCorporateNLFullCustomerDetailsAllOfNatureOfBusiness**](BaseCorporateNLFullCustomerDetailsAllOfNatureOfBusiness.md) |  | [default to undefined]
**expectedAccountUsage** | [**BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsage**](BaseCorporateNLFullCustomerDetailsAllOfExpectedAccountUsage.md) |  | [default to undefined]
...
**applicant** | [**NLFullApplicantDetailsResponse**](NLFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**NLFullApplicantAndStakeholderDetailsResponseStakeholders**](NLFullApplicantAndStakeholderDetailsResponseStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsNL&gt;**](BusinessDocumentsNL.md) |  | [optional] [default to undefined]
...
```typescript
import { NLFullLimitedLiabilityPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: NLFullLimitedLiabilityPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
