# UKFullPublicCompanyCustomerDetailsResponse
...
```typescript
import { UKFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: UKFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
