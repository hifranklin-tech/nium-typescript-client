# UKFullTrustCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Trust businessType
...
```typescript
import { UKFullTrustCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullTrustCustomerDetailsUpdate = {
