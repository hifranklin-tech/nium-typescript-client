# IndividualAUFullCustomerDetailsWithParent
...
```typescript
import { IndividualAUFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
