# BZFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
