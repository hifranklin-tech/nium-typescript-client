# BaseCorporateMXFullCustomerDetailsUpdate

Contains common update customer details for corporate, MX region, full kycType
...
```typescript
import { BaseCorporateMXFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateMXFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
