# BaseCorporateAUFullCustomerDetailsUpdate

Contains common update customer details for corporate, AU region, full kycType
...
```typescript
import { BaseCorporateAUFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateAUFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
