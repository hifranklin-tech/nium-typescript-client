# IndividualUSFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualUSFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
