# CorporateIDFullCustomerDetails

Contains customer details for ID, Corporate and full kycType
...
```typescript
import { CorporateIDFullCustomerDetails } from 'nium-client';

const instance: CorporateIDFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
