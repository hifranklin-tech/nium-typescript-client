# IDFullCooperativeCustomerDetails

Contains customer details for ID, corporate, full kycType and Co-operative businessType
...
```typescript
import { IDFullCooperativeCustomerDetails } from 'nium-client';

const instance: IDFullCooperativeCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
