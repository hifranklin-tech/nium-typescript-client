# EUFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullPrivateCompanyWithoutSearchIdCustomerDetailsUpdate = {
