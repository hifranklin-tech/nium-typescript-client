# EUFullGovernmentEntityWithSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullGovernmentEntityWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullGovernmentEntityWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
