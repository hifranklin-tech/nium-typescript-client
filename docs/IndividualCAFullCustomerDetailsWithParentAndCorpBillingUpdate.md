# IndividualCAFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualCAFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParentAndCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
