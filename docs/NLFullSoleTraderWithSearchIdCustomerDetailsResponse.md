# NLFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { NLFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: NLFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
