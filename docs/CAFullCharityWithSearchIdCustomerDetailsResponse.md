# CAFullCharityWithSearchIdCustomerDetailsResponse
...
```typescript
import { CAFullCharityWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: CAFullCharityWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
