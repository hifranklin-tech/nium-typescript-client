# AUFullGovernmentEntityCustomerDetails
...
```typescript
import { AUFullGovernmentEntityCustomerDetails } from 'nium-client';

const instance: AUFullGovernmentEntityCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
