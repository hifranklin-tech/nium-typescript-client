# CorporateCAFullCustomerDetailsUpdate

Contains update customer details for CA, Corporate and full kycType
...
```typescript
import { CorporateCAFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateCAFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
