# USFullLimitedLiabilityCompanyCustomerDetailsUpdate
...
```typescript
import { USFullLimitedLiabilityCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: USFullLimitedLiabilityCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
