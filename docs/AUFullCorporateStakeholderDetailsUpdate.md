# AUFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for AU, Full KYC
...
```typescript
import { AUFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: AUFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
