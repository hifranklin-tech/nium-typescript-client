# BZMinApplicantDetailsUpdate

Applicant Update Details for MX, minimum KYC
...
```typescript
import { BZMinApplicantDetailsUpdate } from 'nium-client';

const instance: BZMinApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
