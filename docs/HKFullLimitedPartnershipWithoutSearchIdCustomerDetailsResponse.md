# HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
