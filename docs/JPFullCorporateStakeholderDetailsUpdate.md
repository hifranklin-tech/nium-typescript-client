# JPFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for JP, Full KYC
...
```typescript
import { JPFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: JPFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
