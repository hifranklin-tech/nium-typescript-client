# SGFullPartnershipCustomerDetailsResponse
...
```typescript
import { SGFullPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: SGFullPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
