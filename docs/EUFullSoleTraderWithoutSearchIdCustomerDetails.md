# EUFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
