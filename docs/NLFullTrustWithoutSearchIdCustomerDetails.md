# NLFullTrustWithoutSearchIdCustomerDetails
...
```typescript
import { NLFullTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
