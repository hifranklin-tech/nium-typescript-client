# IndividualHKFullCustomerDetailsUpdate
...
```typescript
import { IndividualHKFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
