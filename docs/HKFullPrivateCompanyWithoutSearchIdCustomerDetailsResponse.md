# HKFullPrivateCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullPrivateCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullPrivateCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
