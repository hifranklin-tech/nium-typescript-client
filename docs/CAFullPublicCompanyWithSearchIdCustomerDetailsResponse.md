# CAFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { CAFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: CAFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
