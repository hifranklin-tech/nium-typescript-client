# IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
