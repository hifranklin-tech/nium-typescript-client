# MXFullIndividualStakeholderDetailsResponse

Individual Stakeholder Response Details for MX, Full KYC
...
```typescript
import { MXFullIndividualStakeholderDetailsResponse } from 'nium-client';

const instance: MXFullIndividualStakeholderDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
