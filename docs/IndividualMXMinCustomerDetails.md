# IndividualMXMinCustomerDetails

Contains customer details for MX, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualMXMinCustomerDetailsAllOfDocuments&gt;**](IndividualMXMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualMXMinCustomerDetails } from 'nium-client';

const instance: IndividualMXMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
