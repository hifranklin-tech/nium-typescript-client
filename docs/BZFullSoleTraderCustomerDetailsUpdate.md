# BZFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { BZFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
