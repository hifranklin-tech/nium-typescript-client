# IndividualUSFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualUSFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
