# IndividualNLFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualNLFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithParentAndCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
