# USFullApplicantDetailsCreate

Applicant create Details for US region, Full KYC
...
```typescript
import { USFullApplicantDetailsCreate } from 'nium-client';

const instance: USFullApplicantDetailsCreate = {
    externalId,
    firstName,
    middleName,
    lastName,
