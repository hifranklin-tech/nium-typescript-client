# IDFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { IDFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: IDFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
