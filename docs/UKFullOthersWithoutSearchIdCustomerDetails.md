# UKFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
