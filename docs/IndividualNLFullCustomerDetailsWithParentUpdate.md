# IndividualNLFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualNLFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
