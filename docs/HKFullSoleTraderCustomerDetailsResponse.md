# HKFullSoleTraderCustomerDetailsResponse
...
```typescript
import { HKFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: HKFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
