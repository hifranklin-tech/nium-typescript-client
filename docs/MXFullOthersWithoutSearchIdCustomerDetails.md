# MXFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { MXFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: MXFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
