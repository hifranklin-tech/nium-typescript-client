# CorporateUKFullCustomerDetailsResponse
...
```typescript
import { CorporateUKFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateUKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
