# IndividualEUFullCustomerDetailsResponse
...
```typescript
import { IndividualEUFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
