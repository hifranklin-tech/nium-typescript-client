# IndividualHKMinCustomerDetails

Contains customer details for HK, Individual and minimum kycType
...
```typescript
import { IndividualHKMinCustomerDetails } from 'nium-client';

const instance: IndividualHKMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
