# UKFullSoleTraderWithSearchIdCustomerDetailsResponse
...
```typescript
import { UKFullSoleTraderWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: UKFullSoleTraderWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
