# UKFullAssociationCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Association businessType
...
```typescript
import { UKFullAssociationCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullAssociationCustomerDetailsUpdate = {
