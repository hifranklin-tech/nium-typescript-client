# NLFullAssociationCustomerDetailsResponse

Contains customer details for NL, corporate, full kycType and Association businessType
...
```typescript
import { NLFullAssociationCustomerDetailsResponse } from 'nium-client';

const instance: NLFullAssociationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
