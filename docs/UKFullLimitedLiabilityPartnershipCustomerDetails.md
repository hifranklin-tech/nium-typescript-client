# UKFullLimitedLiabilityPartnershipCustomerDetails
...
```typescript
import { UKFullLimitedLiabilityPartnershipCustomerDetails } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
