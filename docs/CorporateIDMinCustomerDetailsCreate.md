# CorporateIDMinCustomerDetailsCreate
...
**applicant** | [**IDMinApplicantDetails**](IDMinApplicantDetails.md) |  | [default to undefined]
**stakeholders** | [**CorporateIDMinCustomerDetailsCreateAllOfStakeholders**](CorporateIDMinCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateIDMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateIDMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
