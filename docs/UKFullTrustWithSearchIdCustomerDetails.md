# UKFullTrustWithSearchIdCustomerDetails
...
```typescript
import { UKFullTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
