# HKFullCorporateStakeholderDetails

Corporate Stakeholder Details for HK region, Full KYC
...
```typescript
import { HKFullCorporateStakeholderDetails } from 'nium-client';

const instance: HKFullCorporateStakeholderDetails = {
    externalId,
    businessName,
