# CorporateAUFullCustomerDetails

Contains customer details for AU, Corporate and full kycType
...
```typescript
import { CorporateAUFullCustomerDetails } from 'nium-client';

const instance: CorporateAUFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
