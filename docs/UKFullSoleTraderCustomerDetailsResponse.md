# UKFullSoleTraderCustomerDetailsResponse
...
```typescript
import { UKFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: UKFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
