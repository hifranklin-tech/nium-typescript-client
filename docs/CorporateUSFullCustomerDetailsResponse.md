# CorporateUSFullCustomerDetailsResponse
...
```typescript
import { CorporateUSFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateUSFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
