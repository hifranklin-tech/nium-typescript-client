# EUFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
