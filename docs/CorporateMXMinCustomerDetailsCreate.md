# CorporateMXMinCustomerDetailsCreate

Contains create customer details for corporate, MX region, minimum kycType
...
**applicant** | [**MXMinApplicantDetails**](MXMinApplicantDetails.md) |  | [default to undefined]
**stakeholders** | [**CorporateMXMinCustomerDetailsCreateAllOfStakeholders**](CorporateMXMinCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateMXMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateMXMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
