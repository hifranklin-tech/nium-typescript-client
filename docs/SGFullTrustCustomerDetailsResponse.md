# SGFullTrustCustomerDetailsResponse

Contains customer details for SG, corporate, full kycType and Regulated Trust businessType
...
```typescript
import { SGFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: SGFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
