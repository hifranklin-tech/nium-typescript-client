# EUFullLimitedLiabilityPartnershipCustomerDetailsUpdate
...
**applicant** | [**EUFullApplicantDetailsUpdate**](EUFullApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**EUFullApplicantAndStakeholderDetailsUpdateStakeholders**](EUFullApplicantAndStakeholderDetailsUpdateStakeholders.md) |  | [optional] [default to undefined]
...
```typescript
import { EUFullLimitedLiabilityPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipCustomerDetailsUpdate = {
