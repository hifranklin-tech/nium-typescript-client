# JPFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for JP, Full KYC
...
```typescript
import { JPFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: JPFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
