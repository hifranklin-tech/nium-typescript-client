# HKFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { HKFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
