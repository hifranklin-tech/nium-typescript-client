# JPFullPublicCompanyCustomerDetailsResponse

Contains customer details for JP, corporate, full kycType and Public Company businessType
...
```typescript
import { JPFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: JPFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
