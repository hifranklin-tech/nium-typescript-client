# HKFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
