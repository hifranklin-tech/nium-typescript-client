# BZFullLimitedPartnershipCustomerDetails
...
```typescript
import { BZFullLimitedPartnershipCustomerDetails } from 'nium-client';

const instance: BZFullLimitedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
