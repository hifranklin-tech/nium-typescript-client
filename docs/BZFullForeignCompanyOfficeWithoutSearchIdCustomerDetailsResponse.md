# BZFullForeignCompanyOfficeWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullForeignCompanyOfficeWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullForeignCompanyOfficeWithoutSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
