# UKFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { UKFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
