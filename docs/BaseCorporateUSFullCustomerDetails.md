# BaseCorporateUSFullCustomerDetails

Contains common customer details for corporate, US region, full kycType
...
```typescript
import { BaseCorporateUSFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateUSFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
