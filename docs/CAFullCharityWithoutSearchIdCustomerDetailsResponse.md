# CAFullCharityWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { CAFullCharityWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: CAFullCharityWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
