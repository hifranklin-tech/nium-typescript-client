# MXFullGeneralPartnershipCustomerDetails
...
```typescript
import { MXFullGeneralPartnershipCustomerDetails } from 'nium-client';

const instance: MXFullGeneralPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
