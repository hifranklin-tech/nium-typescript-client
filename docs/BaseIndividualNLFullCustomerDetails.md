# BaseIndividualNLFullCustomerDetails

Contains customer details for NL, Individual and full kycType
...
```typescript
import { BaseIndividualNLFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualNLFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
