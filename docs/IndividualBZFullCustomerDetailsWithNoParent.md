# IndividualBZFullCustomerDetailsWithNoParent
...
```typescript
import { IndividualBZFullCustomerDetailsWithNoParent } from 'nium-client';

const instance: IndividualBZFullCustomerDetailsWithNoParent = {
    type,
    kycType,
    region,
    externalId,
