# CorporateAUMinCustomerDetailsCreate

Contains create customer details for corporate, AU region, minimum kycType
...
**addresses** | [**CorporateAUMinCustomerDetailsAllOfAddresses**](CorporateAUMinCustomerDetailsAllOfAddresses.md) |  | [default to undefined]
...
```typescript
import { CorporateAUMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateAUMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
