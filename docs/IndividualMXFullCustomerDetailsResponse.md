# IndividualMXFullCustomerDetailsResponse
...
```typescript
import { IndividualMXFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualMXFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
