# EUFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { EUFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
