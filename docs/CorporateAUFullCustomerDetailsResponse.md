# CorporateAUFullCustomerDetailsResponse

Contains customer details response for AU, Corporate and full kycType
...
```typescript
import { CorporateAUFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateAUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
