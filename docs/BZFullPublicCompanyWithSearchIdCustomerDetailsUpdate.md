# BZFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { BZFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
