# EUFullPrivateCompanyWithSearchIdCustomerDetails
...
```typescript
import { EUFullPrivateCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullPrivateCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
