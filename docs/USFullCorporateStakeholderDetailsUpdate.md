# USFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for US, Full KYC
...
```typescript
import { USFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: USFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
