# NLFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for NL, Full KYC
...
```typescript
import { NLFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: NLFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
