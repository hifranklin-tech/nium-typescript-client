# UsIndividualStakeholderResidentEKycRequest
...
```typescript
import { UsIndividualStakeholderResidentEKycRequest } from 'nium-client';

const instance: UsIndividualStakeholderResidentEKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
