# EUFullApplicantDetailsUpdate

Applicant Update Details for EU, full KYC
...
```typescript
import { EUFullApplicantDetailsUpdate } from 'nium-client';

const instance: EUFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
