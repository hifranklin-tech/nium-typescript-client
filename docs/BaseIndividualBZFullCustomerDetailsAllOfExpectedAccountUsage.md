# BaseIndividualBZFullCustomerDetailsAllOfExpectedAccountUsage
...
```typescript
import { BaseIndividualBZFullCustomerDetailsAllOfExpectedAccountUsage } from 'nium-client';

const instance: BaseIndividualBZFullCustomerDetailsAllOfExpectedAccountUsage = {
    intendedUses,
