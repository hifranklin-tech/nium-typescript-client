# IDFullPrivateLimitedCompanyCustomerDetails
...
```typescript
import { IDFullPrivateLimitedCompanyCustomerDetails } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
