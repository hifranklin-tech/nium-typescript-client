# BZFullPrivateCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullPrivateCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullPrivateCompanyWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
