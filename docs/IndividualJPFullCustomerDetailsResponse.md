# IndividualJPFullCustomerDetailsResponse
...
```typescript
import { IndividualJPFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
