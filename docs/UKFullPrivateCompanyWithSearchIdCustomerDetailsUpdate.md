# UKFullPrivateCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullPrivateCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPrivateCompanyWithSearchIdCustomerDetailsUpdate = {
