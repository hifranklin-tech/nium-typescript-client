# UKFullApplicantDetailsResponse

Applicant Response Details for UK, full KYC
...
```typescript
import { UKFullApplicantDetailsResponse } from 'nium-client';

const instance: UKFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
