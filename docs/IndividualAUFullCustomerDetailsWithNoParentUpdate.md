# IndividualAUFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualAUFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualAUFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
