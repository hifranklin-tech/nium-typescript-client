# USFullCorporateStakeholderDetails

Corporate Stakeholder Details for US region, Full KYC
...
```typescript
import { USFullCorporateStakeholderDetails } from 'nium-client';

const instance: USFullCorporateStakeholderDetails = {
    externalId,
    businessName,
