# EUFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for EU, Full KYC
...
```typescript
import { EUFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: EUFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
