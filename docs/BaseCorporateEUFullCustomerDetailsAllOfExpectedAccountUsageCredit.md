# BaseCorporateEUFullCustomerDetailsAllOfExpectedAccountUsageCredit
...
**topRemitters** | **Array&lt;string&gt;** | Array of expected primary remitters. Can be specific companies or types of entities | [default to undefined]

## Example

```typescript
import { BaseCorporateEUFullCustomerDetailsAllOfExpectedAccountUsageCredit } from 'nium-client';

const instance: BaseCorporateEUFullCustomerDetailsAllOfExpectedAccountUsageCredit = {
