# BaseCorporateEUFullCustomerDetailsCreate

Contains common create customer details for corporate, EU region, full kycType
...
```typescript
import { BaseCorporateEUFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateEUFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
