# NLFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { NLFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
