# USFullApplicantDetailsUpdate

Applicant Update Details for US, full KYC
...
```typescript
import { USFullApplicantDetailsUpdate } from 'nium-client';

const instance: USFullApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
