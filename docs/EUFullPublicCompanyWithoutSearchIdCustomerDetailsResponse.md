# EUFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { EUFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: EUFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
