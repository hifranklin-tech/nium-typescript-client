# CorporateBZMinCustomerDetailsResponse
...
```typescript
import { CorporateBZMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateBZMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
