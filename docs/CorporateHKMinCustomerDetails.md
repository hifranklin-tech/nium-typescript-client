# CorporateHKMinCustomerDetails

Contains customer details for HK, corporate and minimum kycType
...
```typescript
import { CorporateHKMinCustomerDetails } from 'nium-client';

const instance: CorporateHKMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
