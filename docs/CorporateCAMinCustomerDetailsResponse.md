# CorporateCAMinCustomerDetailsResponse
...
```typescript
import { CorporateCAMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateCAMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
