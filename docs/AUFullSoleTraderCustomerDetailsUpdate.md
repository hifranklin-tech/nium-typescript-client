# AUFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { AUFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
