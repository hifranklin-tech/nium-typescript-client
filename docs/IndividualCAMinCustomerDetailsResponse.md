# IndividualCAMinCustomerDetailsResponse
...
```typescript
import { IndividualCAMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualCAMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
