# IndividualNLFullCustomerDetailsWithParent
...
```typescript
import { IndividualNLFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
