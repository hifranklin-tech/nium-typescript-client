# MXFullOthersCustomerDetailsUpdate

Contains customer details for MX, corporate, full kycType and Others businessType
...
```typescript
import { MXFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullOthersCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
