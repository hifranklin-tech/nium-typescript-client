# BaseIndividualMXFullCustomerDetails

Contains customer details for MX, Individual and full kycType
...
```typescript
import { BaseIndividualMXFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualMXFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
