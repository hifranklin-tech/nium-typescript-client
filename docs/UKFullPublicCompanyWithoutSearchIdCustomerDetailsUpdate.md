# UKFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullPublicCompanyWithoutSearchIdCustomerDetailsUpdate = {
