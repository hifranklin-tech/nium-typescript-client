# IndividualHKFullCustomerDetailsResponse
...
```typescript
import { IndividualHKFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
