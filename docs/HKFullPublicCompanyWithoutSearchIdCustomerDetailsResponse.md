# HKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { HKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: HKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
