# AUFullRegulatedTrustCustomerDetails

Contains customer details for AU, corporate, full kycType and RegulatedTrust businessType
...
```typescript
import { AUFullRegulatedTrustCustomerDetails } from 'nium-client';

const instance: AUFullRegulatedTrustCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
