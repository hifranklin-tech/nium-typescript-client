# BaseCorporateUKFullCustomerDetailsUpdate

Contains common update customer details for corporate, UK region, full kycType
...
```typescript
import { BaseCorporateUKFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateUKFullCustomerDetailsUpdate = {
