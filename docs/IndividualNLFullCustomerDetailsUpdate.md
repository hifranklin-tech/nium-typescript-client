# IndividualNLFullCustomerDetailsUpdate
...
```typescript
import { IndividualNLFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
