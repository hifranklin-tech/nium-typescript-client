# AUFullGovernmentEntityCustomerDetailsUpdate
...
```typescript
import { AUFullGovernmentEntityCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullGovernmentEntityCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
