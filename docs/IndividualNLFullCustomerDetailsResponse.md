# IndividualNLFullCustomerDetailsResponse
...
```typescript
import { IndividualNLFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualNLFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
