# NLFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails
...
```typescript
import { NLFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
