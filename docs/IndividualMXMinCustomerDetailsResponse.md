# IndividualMXMinCustomerDetailsResponse
...
```typescript
import { IndividualMXMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualMXMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
