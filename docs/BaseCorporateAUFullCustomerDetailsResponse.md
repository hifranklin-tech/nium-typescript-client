# BaseCorporateAUFullCustomerDetailsResponse

Contains common customer details response for corporate, AU region, full kycType
...
```typescript
import { BaseCorporateAUFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateAUFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
