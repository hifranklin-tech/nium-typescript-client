# EUFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullGovernmentEntityWithoutSearchIdCustomerDetailsUpdate = {
