# UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails
...
```typescript
import { UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullLimitedLiabilityPartnershipWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
