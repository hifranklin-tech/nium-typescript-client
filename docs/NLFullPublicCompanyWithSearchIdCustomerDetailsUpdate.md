# NLFullPublicCompanyWithSearchIdCustomerDetailsUpdate
...
```typescript
import { NLFullPublicCompanyWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: NLFullPublicCompanyWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
