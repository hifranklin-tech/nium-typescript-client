# CAFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
