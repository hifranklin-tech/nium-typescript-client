# NLFullTrustWithSearchIdCustomerDetails
...
```typescript
import { NLFullTrustWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullTrustWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
