# EUFullAssociationWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullAssociationWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullAssociationWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
