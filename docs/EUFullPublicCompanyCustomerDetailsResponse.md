# EUFullPublicCompanyCustomerDetailsResponse

Contains customer details for EU, corporate, full kycType and Public Company businessType
...
```typescript
import { EUFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: EUFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
