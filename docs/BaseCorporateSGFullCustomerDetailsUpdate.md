# BaseCorporateSGFullCustomerDetailsUpdate

Contains common update customer details for corporate, SG region, full kycType
...
```typescript
import { BaseCorporateSGFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateSGFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
