# UKFullGovernmentEntityCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Government Entity businessType
...
```typescript
import { UKFullGovernmentEntityCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullGovernmentEntityCustomerDetailsUpdate = {
