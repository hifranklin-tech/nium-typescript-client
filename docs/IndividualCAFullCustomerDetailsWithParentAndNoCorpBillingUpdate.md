# IndividualCAFullCustomerDetailsWithParentAndNoCorpBillingUpdate
...
```typescript
import { IndividualCAFullCustomerDetailsWithParentAndNoCorpBillingUpdate } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsWithParentAndNoCorpBillingUpdate = {
    type,
    kycType,
    region,
    externalId,
