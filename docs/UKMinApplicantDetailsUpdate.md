# UKMinApplicantDetailsUpdate

Applicant Update Details for UK, minimum KYC
...
```typescript
import { UKMinApplicantDetailsUpdate } from 'nium-client';

const instance: UKMinApplicantDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
