# UsIndividualCustomerNonResidentManualKycRequest
...
```typescript
import { UsIndividualCustomerNonResidentManualKycRequest } from 'nium-client';

const instance: UsIndividualCustomerNonResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
