# UsIndividualCustomerResidentManualKycRequest
...
```typescript
import { UsIndividualCustomerResidentManualKycRequest } from 'nium-client';

const instance: UsIndividualCustomerResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
