# IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
