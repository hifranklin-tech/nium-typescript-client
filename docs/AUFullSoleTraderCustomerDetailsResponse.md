# AUFullSoleTraderCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Sole Trader businessType
...
**businessRegistrationNumber** | **string** |  official registration number - must be exactly 11 alphanumeric characters for Sole Trader | [default to undefined]
...
```typescript
import { AUFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: AUFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
