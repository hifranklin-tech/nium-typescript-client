# CAFullCharityWithSearchIdCustomerDetails
...
```typescript
import { CAFullCharityWithSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullCharityWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
