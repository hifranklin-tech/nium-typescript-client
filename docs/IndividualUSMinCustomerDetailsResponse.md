# IndividualUSMinCustomerDetailsResponse
...
```typescript
import { IndividualUSMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualUSMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
