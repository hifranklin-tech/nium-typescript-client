# IndividualJPFullCustomerDetailsUpdate
...
```typescript
import { IndividualJPFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualJPFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
