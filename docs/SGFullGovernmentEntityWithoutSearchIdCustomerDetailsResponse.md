# SGFullGovernmentEntityWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullGovernmentEntityWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullGovernmentEntityWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
