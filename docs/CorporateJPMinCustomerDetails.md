# CorporateJPMinCustomerDetails

Contains customer details for JP, corporate and minimum kycType
...
```typescript
import { CorporateJPMinCustomerDetails } from 'nium-client';

const instance: CorporateJPMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
