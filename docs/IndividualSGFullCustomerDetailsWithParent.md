# IndividualSGFullCustomerDetailsWithParent
...
```typescript
import { IndividualSGFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
