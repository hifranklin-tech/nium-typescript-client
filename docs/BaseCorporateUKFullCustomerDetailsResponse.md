# BaseCorporateUKFullCustomerDetailsResponse

Contains common customer details response for corporate, UK region, full kycType
...
```typescript
import { BaseCorporateUKFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateUKFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
