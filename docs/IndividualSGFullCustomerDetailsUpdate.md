# IndividualSGFullCustomerDetailsUpdate
...
```typescript
import { IndividualSGFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
