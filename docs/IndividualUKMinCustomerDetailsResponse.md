# IndividualUKMinCustomerDetailsResponse
...
```typescript
import { IndividualUKMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualUKMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
