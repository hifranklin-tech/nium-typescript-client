# CorporateSGFullCustomerDetailsResponse

Contains customer details response for SG, Corporate and full kycType
...
```typescript
import { CorporateSGFullCustomerDetailsResponse } from 'nium-client';

const instance: CorporateSGFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
