# HKFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { HKFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: HKFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
