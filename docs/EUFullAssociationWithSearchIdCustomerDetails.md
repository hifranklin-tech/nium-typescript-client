# EUFullAssociationWithSearchIdCustomerDetails
...
```typescript
import { EUFullAssociationWithSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullAssociationWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
