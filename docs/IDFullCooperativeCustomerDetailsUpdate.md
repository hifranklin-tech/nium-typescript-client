# IDFullCooperativeCustomerDetailsUpdate
...
```typescript
import { IDFullCooperativeCustomerDetailsUpdate } from 'nium-client';

const instance: IDFullCooperativeCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
