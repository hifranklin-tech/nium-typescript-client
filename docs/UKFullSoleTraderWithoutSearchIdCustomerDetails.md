# UKFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
