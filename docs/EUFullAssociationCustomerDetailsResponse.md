# EUFullAssociationCustomerDetailsResponse
...
```typescript
import { EUFullAssociationCustomerDetailsResponse } from 'nium-client';

const instance: EUFullAssociationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
