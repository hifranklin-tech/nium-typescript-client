# SGFullGovernmentEntityWithSearchIdCustomerDetails
...
```typescript
import { SGFullGovernmentEntityWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullGovernmentEntityWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
