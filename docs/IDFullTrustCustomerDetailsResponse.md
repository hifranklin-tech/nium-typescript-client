# IDFullTrustCustomerDetailsResponse

Contains customer details for ID, corporate, full kycType and Trust businessType
...
```typescript
import { IDFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: IDFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
