# SGFullPublicCompanyWithSearchIdCustomerDetails
...
```typescript
import { SGFullPublicCompanyWithSearchIdCustomerDetails } from 'nium-client';

const instance: SGFullPublicCompanyWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
