# HKFullLimitedPartnershipCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Limited Partnership businessType
...
```typescript
import { HKFullLimitedPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullLimitedPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
