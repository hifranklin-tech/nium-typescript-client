# BaseCorporateHKFullCustomerDetailsCreate

Contains common create customer details for corporate, HK region, full kycType
...
```typescript
import { BaseCorporateHKFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateHKFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
