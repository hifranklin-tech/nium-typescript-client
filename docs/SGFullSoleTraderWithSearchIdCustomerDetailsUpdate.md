# SGFullSoleTraderWithSearchIdCustomerDetailsUpdate
...
```typescript
import { SGFullSoleTraderWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: SGFullSoleTraderWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
