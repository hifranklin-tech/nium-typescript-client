# BZFullGeneralPartnershipCustomerDetailsResponse

Contains customer details for BZ, corporate, full kycType and General Partnership businessType
...
**applicant** | [**BZFullApplicantDetailsResponse**](BZFullApplicantDetailsResponse.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateBZFullCustomerDetailsResponseAllOfStakeholders**](BaseCorporateBZFullCustomerDetailsResponseAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsBZ&gt;**](BusinessDocumentsBZ.md) |  | [optional] [default to undefined]
...
```typescript
import { BZFullGeneralPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: BZFullGeneralPartnershipCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
