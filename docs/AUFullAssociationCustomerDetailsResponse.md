# AUFullAssociationCustomerDetailsResponse

Contains customer details for AU, corporate, full kycType and Association businessType
...
**businessRegistrationNumber** | **string** | official registration number - must be exactly 11 alphanumeric characters for Association | [default to undefined]
...
```typescript
import { AUFullAssociationCustomerDetailsResponse } from 'nium-client';

const instance: AUFullAssociationCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
