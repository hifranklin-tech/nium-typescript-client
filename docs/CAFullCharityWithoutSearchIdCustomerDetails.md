# CAFullCharityWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullCharityWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullCharityWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
