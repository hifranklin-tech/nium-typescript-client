# IDFullSoleTraderWithSearchIdCustomerDetails
...
```typescript
import { IDFullSoleTraderWithSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullSoleTraderWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
