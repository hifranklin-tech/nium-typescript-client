# CorporateHKMinCustomerDetailsUpdate

Contains update customer details for corporate, HK region, minimum kycType
...
**applicant** | [**HKMinApplicantDetailsUpdate**](HKMinApplicantDetailsUpdate.md) |  | [default to undefined]
**stakeholders** | [**CorporateHKMinCustomerDetailsUpdateAllOfStakeholders**](CorporateHKMinCustomerDetailsUpdateAllOfStakeholders.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CorporateHKMinCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateHKMinCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
