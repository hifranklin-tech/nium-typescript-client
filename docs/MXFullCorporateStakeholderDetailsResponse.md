# MXFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for MX, Full KYC
...
```typescript
import { MXFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: MXFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
