# USFullGeneralPartnershipCustomerDetailsUpdate
...
```typescript
import { USFullGeneralPartnershipCustomerDetailsUpdate } from 'nium-client';

const instance: USFullGeneralPartnershipCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
