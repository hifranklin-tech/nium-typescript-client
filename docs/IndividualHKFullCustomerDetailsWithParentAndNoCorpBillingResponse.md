# IndividualHKFullCustomerDetailsWithParentAndNoCorpBillingResponse
...
```typescript
import { IndividualHKFullCustomerDetailsWithParentAndNoCorpBillingResponse } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithParentAndNoCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
