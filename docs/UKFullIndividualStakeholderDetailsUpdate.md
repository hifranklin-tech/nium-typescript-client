# UKFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for UK, Full KYC
...
```typescript
import { UKFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: UKFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
