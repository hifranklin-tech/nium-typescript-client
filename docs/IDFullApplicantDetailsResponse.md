# IDFullApplicantDetailsResponse

Applicant Response Details for ID, full KYC
...
```typescript
import { IDFullApplicantDetailsResponse } from 'nium-client';

const instance: IDFullApplicantDetailsResponse = {
    externalId,
    firstName,
    middleName,
    lastName,
