# IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: IDFullPrivateLimitedCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
