# UKFullSoleTraderCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Sole Trader businessType
...
```typescript
import { UKFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullSoleTraderCustomerDetailsUpdate = {
