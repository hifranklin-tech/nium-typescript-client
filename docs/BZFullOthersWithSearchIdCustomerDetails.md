# BZFullOthersWithSearchIdCustomerDetails
...
```typescript
import { BZFullOthersWithSearchIdCustomerDetails } from 'nium-client';

const instance: BZFullOthersWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
