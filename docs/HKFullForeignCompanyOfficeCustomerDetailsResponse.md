# HKFullForeignCompanyOfficeCustomerDetailsResponse
...
```typescript
import { HKFullForeignCompanyOfficeCustomerDetailsResponse } from 'nium-client';

const instance: HKFullForeignCompanyOfficeCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
