# USFullLimitedLiabilityCompanyCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and LimitedLiabilityCompany businessType
...
```typescript
import { USFullLimitedLiabilityCompanyCustomerDetailsResponse } from 'nium-client';

const instance: USFullLimitedLiabilityCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
