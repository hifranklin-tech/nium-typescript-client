# CorporateHKFullCustomerDetailsUpdate

Contains update customer details for HK, Corporate and full kycType
...
```typescript
import { CorporateHKFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateHKFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
