# USFullUnincorporatedPartnershipCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and UnincorporatedPartnership businessType
...
```typescript
import { USFullUnincorporatedPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: USFullUnincorporatedPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
