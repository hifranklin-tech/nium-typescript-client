# IndividualSGFullCustomerDetailsWithParentUpdate
...
```typescript
import { IndividualSGFullCustomerDetailsWithParentUpdate } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsWithParentUpdate = {
    type,
    kycType,
    region,
    externalId,
