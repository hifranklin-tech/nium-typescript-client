# HKFullOthersWithoutSearchIdCustomerDetails
...
```typescript
import { HKFullOthersWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: HKFullOthersWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
