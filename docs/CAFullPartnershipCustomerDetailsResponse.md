# CAFullPartnershipCustomerDetailsResponse

Contains customer details for CA, corporate, full kycType and Partnership businessType
...
```typescript
import { CAFullPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: CAFullPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
