# CAFullPrivateCompanyCustomerDetailsUpdate
...
```typescript
import { CAFullPrivateCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: CAFullPrivateCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
