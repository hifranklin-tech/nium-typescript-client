# CorporateUSMinCustomerDetails

Contains customer details for US, corporate and minimum kycType
...
```typescript
import { CorporateUSMinCustomerDetails } from 'nium-client';

const instance: CorporateUSMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
