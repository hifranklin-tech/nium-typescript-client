# UKFullTrustWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullTrustWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullTrustWithoutSearchIdCustomerDetailsUpdate = {
