# CorporateUKMinCustomerDetailsCreate

Contains create customer details for corporate, UK region, minimum kycType
...
```typescript
import { CorporateUKMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateUKMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
