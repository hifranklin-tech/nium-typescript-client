# EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: EUFullLimitedLiabilityPartnershipWithoutSearchIdCustomerDetailsUpdate = {
