# IndividualIDFullCustomerDetailsWithNoParentResponse
...
```typescript
import { IndividualIDFullCustomerDetailsWithNoParentResponse } from 'nium-client';

const instance: IndividualIDFullCustomerDetailsWithNoParentResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
