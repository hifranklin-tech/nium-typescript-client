# BaseCorporateUSFullCustomerDetailsUpdate

Contains common update customer details for corporate, US region, full kycType
...
```typescript
import { BaseCorporateUSFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateUSFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
