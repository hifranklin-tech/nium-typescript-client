# MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate
...
```typescript
import { MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullForeignCompanyOfficeWithSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
