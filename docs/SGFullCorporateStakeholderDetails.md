# SGFullCorporateStakeholderDetails

Corporate Stakeholder Details for SG region, Full KYC
...
```typescript
import { SGFullCorporateStakeholderDetails } from 'nium-client';

const instance: SGFullCorporateStakeholderDetails = {
    externalId,
    businessName,
