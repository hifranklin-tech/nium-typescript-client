# CorporateBZFullCustomerDetailsUpdate

Contains update customer details for BZ, Corporate and full kycType
...
```typescript
import { CorporateBZFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateBZFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
