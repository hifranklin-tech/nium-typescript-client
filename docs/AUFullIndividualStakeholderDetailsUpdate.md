# AUFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for AU, Full KYC
...
```typescript
import { AUFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: AUFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
