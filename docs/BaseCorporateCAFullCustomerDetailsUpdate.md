# BaseCorporateCAFullCustomerDetailsUpdate

Contains common update customer details for corporate, CA region, full kycType
...
```typescript
import { BaseCorporateCAFullCustomerDetailsUpdate } from 'nium-client';

const instance: BaseCorporateCAFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
