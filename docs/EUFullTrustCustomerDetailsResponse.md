# EUFullTrustCustomerDetailsResponse

Contains customer details for EU, corporate, full kycType and Trust businessType
...
```typescript
import { EUFullTrustCustomerDetailsResponse } from 'nium-client';

const instance: EUFullTrustCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
