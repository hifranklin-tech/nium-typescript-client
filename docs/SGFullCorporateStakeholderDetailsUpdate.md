# SGFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for SG, Full KYC
...
```typescript
import { SGFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: SGFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
