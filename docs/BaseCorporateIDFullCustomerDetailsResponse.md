# BaseCorporateIDFullCustomerDetailsResponse

Contains common customer details response for corporate, ID region, full kycType
...
```typescript
import { BaseCorporateIDFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateIDFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
