# CorporateNLMinCustomerDetailsResponse
...
```typescript
import { CorporateNLMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateNLMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
