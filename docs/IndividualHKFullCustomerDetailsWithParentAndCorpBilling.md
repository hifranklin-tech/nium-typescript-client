# IndividualHKFullCustomerDetailsWithParentAndCorpBilling
...
```typescript
import { IndividualHKFullCustomerDetailsWithParentAndCorpBilling } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithParentAndCorpBilling = {
    type,
    kycType,
    region,
    externalId,
