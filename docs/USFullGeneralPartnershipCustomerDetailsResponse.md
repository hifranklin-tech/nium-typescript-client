# USFullGeneralPartnershipCustomerDetailsResponse

Contains customer details for US, corporate, full kycType and General Partnership businessType
...
```typescript
import { USFullGeneralPartnershipCustomerDetailsResponse } from 'nium-client';

const instance: USFullGeneralPartnershipCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
