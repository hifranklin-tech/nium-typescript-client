# IndividualBZFullCustomerDetailsResponse
...
```typescript
import { IndividualBZFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualBZFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
