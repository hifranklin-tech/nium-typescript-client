# UKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { UKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: UKFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
