# BaseCorporateUKFullCustomerDetailsCreate

Contains common create customer details for corporate, UK region, full kycType
...
```typescript
import { BaseCorporateUKFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateUKFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
