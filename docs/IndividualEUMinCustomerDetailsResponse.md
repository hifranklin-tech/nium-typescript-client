# IndividualEUMinCustomerDetailsResponse
...
```typescript
import { IndividualEUMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualEUMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
