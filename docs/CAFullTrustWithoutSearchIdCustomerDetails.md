# CAFullTrustWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullTrustWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullTrustWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
