# NLFullAssociationWithSearchIdCustomerDetails
...
```typescript
import { NLFullAssociationWithSearchIdCustomerDetails } from 'nium-client';

const instance: NLFullAssociationWithSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
