# CorporateAUFullCustomerDetailsUpdate

Contains update customer details for AU, Corporate and full kycType
...
```typescript
import { CorporateAUFullCustomerDetailsUpdate } from 'nium-client';

const instance: CorporateAUFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
