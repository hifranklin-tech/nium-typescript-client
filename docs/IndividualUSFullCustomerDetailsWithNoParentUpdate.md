# IndividualUSFullCustomerDetailsWithNoParentUpdate
...
```typescript
import { IndividualUSFullCustomerDetailsWithNoParentUpdate } from 'nium-client';

const instance: IndividualUSFullCustomerDetailsWithNoParentUpdate = {
    type,
    kycType,
    region,
    externalId,
