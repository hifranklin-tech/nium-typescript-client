# UKFullPublicCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { UKFullPublicCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: UKFullPublicCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
