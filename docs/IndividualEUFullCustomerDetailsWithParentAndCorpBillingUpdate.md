# IndividualEUFullCustomerDetailsWithParentAndCorpBillingUpdate
...
```typescript
import { IndividualEUFullCustomerDetailsWithParentAndCorpBillingUpdate } from 'nium-client';

const instance: IndividualEUFullCustomerDetailsWithParentAndCorpBillingUpdate = {
