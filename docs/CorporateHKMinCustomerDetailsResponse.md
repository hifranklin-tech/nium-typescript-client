# CorporateHKMinCustomerDetailsResponse
...
```typescript
import { CorporateHKMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateHKMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
