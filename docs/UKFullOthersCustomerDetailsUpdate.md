# UKFullOthersCustomerDetailsUpdate

Contains customer details for UK, corporate, full kycType and Others businessType
...
```typescript
import { UKFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullOthersCustomerDetailsUpdate = {
