# BaseCorporateUKFullCustomerDetails

Contains common customer details for corporate, UK region, full kycType
...
```typescript
import { BaseCorporateUKFullCustomerDetails } from 'nium-client';

const instance: BaseCorporateUKFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
