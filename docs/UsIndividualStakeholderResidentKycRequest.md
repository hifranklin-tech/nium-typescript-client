# UsIndividualStakeholderResidentKycRequest
...
```typescript
import { UsIndividualStakeholderResidentKycRequest } from 'nium-client';

const instance: UsIndividualStakeholderResidentKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
