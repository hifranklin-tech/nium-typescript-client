# IndividualAUMinCustomerDetailsResponse
...
```typescript
import { IndividualAUMinCustomerDetailsResponse } from 'nium-client';

const instance: IndividualAUMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
