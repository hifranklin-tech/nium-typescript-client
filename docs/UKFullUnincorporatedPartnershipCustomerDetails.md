# UKFullUnincorporatedPartnershipCustomerDetails
...
**applicant** | [**UKFullApplicantDetailsCreate**](UKFullApplicantDetailsCreate.md) |  | [default to undefined]
**stakeholders** | [**BaseCorporateUKFullCustomerDetailsCreateAllOfStakeholders**](BaseCorporateUKFullCustomerDetailsCreateAllOfStakeholders.md) |  | [optional] [default to undefined]
**documents** | [**Array&lt;BusinessDocumentsUK&gt;**](BusinessDocumentsUK.md) |  | [optional] [default to undefined]

## Example

```typescript
import { UKFullUnincorporatedPartnershipCustomerDetails } from 'nium-client';

const instance: UKFullUnincorporatedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
