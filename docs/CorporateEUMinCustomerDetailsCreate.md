# CorporateEUMinCustomerDetailsCreate

Contains create customer details for corporate, EU region, minimum kycType
...
```typescript
import { CorporateEUMinCustomerDetailsCreate } from 'nium-client';

const instance: CorporateEUMinCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
