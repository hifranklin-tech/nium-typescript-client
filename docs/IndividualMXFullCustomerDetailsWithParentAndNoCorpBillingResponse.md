# IndividualMXFullCustomerDetailsWithParentAndNoCorpBillingResponse
...
```typescript
import { IndividualMXFullCustomerDetailsWithParentAndNoCorpBillingResponse } from 'nium-client';

const instance: IndividualMXFullCustomerDetailsWithParentAndNoCorpBillingResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
