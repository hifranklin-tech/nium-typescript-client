# UKFullGovernmentEntityCustomerOtherDetails
...
```typescript
import { UKFullGovernmentEntityCustomerOtherDetails } from 'nium-client';

const instance: UKFullGovernmentEntityCustomerOtherDetails = {
    tradeName,
    documents,
};
```
