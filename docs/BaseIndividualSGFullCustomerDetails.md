# BaseIndividualSGFullCustomerDetails

Contains customer details for SG, Individual and full kycType
...
```typescript
import { BaseIndividualSGFullCustomerDetails } from 'nium-client';

const instance: BaseIndividualSGFullCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
