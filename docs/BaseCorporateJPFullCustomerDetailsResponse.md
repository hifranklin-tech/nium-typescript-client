# BaseCorporateJPFullCustomerDetailsResponse

Contains common customer details response for corporate, JP region, full kycType
...
```typescript
import { BaseCorporateJPFullCustomerDetailsResponse } from 'nium-client';

const instance: BaseCorporateJPFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
