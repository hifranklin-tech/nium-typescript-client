# UsApplicantResidentManualKycRequest
...
**proofOfIdentityDocument** | [**Array&lt;ProofOfIdentityResidentManual&gt;**](ProofOfIdentityResidentManual.md) | Provide identity verification details for the entity. If only National ID is provided then fileIds become mandatory | [default to undefined]

## Example

```typescript
import { UsApplicantResidentManualKycRequest } from 'nium-client';

const instance: UsApplicantResidentManualKycRequest = {
    region,
    entityType,
    isResident,
    kycMode,
