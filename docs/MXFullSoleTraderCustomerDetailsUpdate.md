# MXFullSoleTraderCustomerDetailsUpdate
...
```typescript
import { MXFullSoleTraderCustomerDetailsUpdate } from 'nium-client';

const instance: MXFullSoleTraderCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
