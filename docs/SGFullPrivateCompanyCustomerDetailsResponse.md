# SGFullPrivateCompanyCustomerDetailsResponse
...
```typescript
import { SGFullPrivateCompanyCustomerDetailsResponse } from 'nium-client';

const instance: SGFullPrivateCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
