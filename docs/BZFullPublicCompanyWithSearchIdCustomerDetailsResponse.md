# BZFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { BZFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: BZFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    type,
    kycType,
    region,
    externalId,
