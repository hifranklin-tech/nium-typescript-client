# EUFullPrivateCompanyWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullPrivateCompanyWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullPrivateCompanyWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
