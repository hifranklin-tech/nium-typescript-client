# BZFullOthersCustomerDetailsUpdate

Contains customer details for BZ, corporate, full kycType and Others businessType
...
```typescript
import { BZFullOthersCustomerDetailsUpdate } from 'nium-client';

const instance: BZFullOthersCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
