# MXFullSoleTraderWithoutSearchIdCustomerDetails
...
```typescript
import { MXFullSoleTraderWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: MXFullSoleTraderWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
