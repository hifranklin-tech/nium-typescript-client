# MXFullIndividualStakeholderDetailsUpdate

Individual Stakeholder Update Details for MX, Full KYC
...
```typescript
import { MXFullIndividualStakeholderDetailsUpdate } from 'nium-client';

const instance: MXFullIndividualStakeholderDetailsUpdate = {
    externalId,
    firstName,
    middleName,
    lastName,
