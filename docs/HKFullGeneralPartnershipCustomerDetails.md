# HKFullGeneralPartnershipCustomerDetails

Contains customer details for HK, corporate, full kycType and General Partnership businessType
...
```typescript
import { HKFullGeneralPartnershipCustomerDetails } from 'nium-client';

const instance: HKFullGeneralPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
