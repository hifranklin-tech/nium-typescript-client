# SGFullSoleTraderCustomerDetailsResponse
...
```typescript
import { SGFullSoleTraderCustomerDetailsResponse } from 'nium-client';

const instance: SGFullSoleTraderCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
