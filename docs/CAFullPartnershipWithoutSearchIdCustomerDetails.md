# CAFullPartnershipWithoutSearchIdCustomerDetails
...
```typescript
import { CAFullPartnershipWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: CAFullPartnershipWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
