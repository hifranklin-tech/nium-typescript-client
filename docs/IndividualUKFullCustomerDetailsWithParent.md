# IndividualUKFullCustomerDetailsWithParent
...
```typescript
import { IndividualUKFullCustomerDetailsWithParent } from 'nium-client';

const instance: IndividualUKFullCustomerDetailsWithParent = {
    type,
    kycType,
    region,
    externalId,
