# BZFullCorporateStakeholderDetailsResponse

Corporate Stakeholder Response Details for BZ, Full KYC
...
```typescript
import { BZFullCorporateStakeholderDetailsResponse } from 'nium-client';

const instance: BZFullCorporateStakeholderDetailsResponse = {
    externalId,
    businessName,
