# SGFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
