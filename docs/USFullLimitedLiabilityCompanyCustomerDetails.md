# USFullLimitedLiabilityCompanyCustomerDetails
...
```typescript
import { USFullLimitedLiabilityCompanyCustomerDetails } from 'nium-client';

const instance: USFullLimitedLiabilityCompanyCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
