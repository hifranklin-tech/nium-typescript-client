# CorporateSGMinCustomerDetailsResponse
...
```typescript
import { CorporateSGMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateSGMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
