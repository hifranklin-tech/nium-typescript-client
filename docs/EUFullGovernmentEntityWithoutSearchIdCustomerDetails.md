# EUFullGovernmentEntityWithoutSearchIdCustomerDetails
...
```typescript
import { EUFullGovernmentEntityWithoutSearchIdCustomerDetails } from 'nium-client';

const instance: EUFullGovernmentEntityWithoutSearchIdCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
