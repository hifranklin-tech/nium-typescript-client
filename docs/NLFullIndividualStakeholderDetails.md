# NLFullIndividualStakeholderDetails

Individual Stakeholder Details for NL region, Full KYC
...
```typescript
import { NLFullIndividualStakeholderDetails } from 'nium-client';

const instance: NLFullIndividualStakeholderDetails = {
    externalId,
    firstName,
    middleName,
    lastName,
