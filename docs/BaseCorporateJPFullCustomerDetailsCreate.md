# BaseCorporateJPFullCustomerDetailsCreate

Contains common create customer details for corporate, JP region, full kycType
...
```typescript
import { BaseCorporateJPFullCustomerDetailsCreate } from 'nium-client';

const instance: BaseCorporateJPFullCustomerDetailsCreate = {
    type,
    kycType,
    region,
    externalId,
