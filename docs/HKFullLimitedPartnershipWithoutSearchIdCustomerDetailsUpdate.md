# HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullLimitedPartnershipWithoutSearchIdCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
