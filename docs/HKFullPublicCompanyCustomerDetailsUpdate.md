# HKFullPublicCompanyCustomerDetailsUpdate

Contains customer details for HK, corporate, full kycType and Public Company businessType
...
```typescript
import { HKFullPublicCompanyCustomerDetailsUpdate } from 'nium-client';

const instance: HKFullPublicCompanyCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
