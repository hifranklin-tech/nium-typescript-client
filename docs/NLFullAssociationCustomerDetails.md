# NLFullAssociationCustomerDetails

Contains customer details for EU, corporate, full kycType and Association businessType
...
```typescript
import { NLFullAssociationCustomerDetails } from 'nium-client';

const instance: NLFullAssociationCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
