# IndividualCAFullCustomerDetailsResponse
...
```typescript
import { IndividualCAFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
