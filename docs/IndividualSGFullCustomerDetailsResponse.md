# IndividualSGFullCustomerDetailsResponse
...
```typescript
import { IndividualSGFullCustomerDetailsResponse } from 'nium-client';

const instance: IndividualSGFullCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
