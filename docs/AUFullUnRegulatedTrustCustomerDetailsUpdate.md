# AUFullUnRegulatedTrustCustomerDetailsUpdate
...
```typescript
import { AUFullUnRegulatedTrustCustomerDetailsUpdate } from 'nium-client';

const instance: AUFullUnRegulatedTrustCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
