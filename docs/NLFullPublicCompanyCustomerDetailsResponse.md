# NLFullPublicCompanyCustomerDetailsResponse
...
```typescript
import { NLFullPublicCompanyCustomerDetailsResponse } from 'nium-client';

const instance: NLFullPublicCompanyCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
