# IndividualAUMinCustomerDetails

Contains customer details for AU, Individual and minimum kycType
...
**documents** | [**Array&lt;IndividualAUMinCustomerDetailsAllOfDocuments&gt;**](IndividualAUMinCustomerDetailsAllOfDocuments.md) | This field accepts list of document details for the customer | [default to undefined]

## Example

```typescript
import { IndividualAUMinCustomerDetails } from 'nium-client';

const instance: IndividualAUMinCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
