# IndividualHKFullCustomerDetailsWithParentResponse
...
```typescript
import { IndividualHKFullCustomerDetailsWithParentResponse } from 'nium-client';

const instance: IndividualHKFullCustomerDetailsWithParentResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
