# BZFullCorporateStakeholderDetailsUpdate

Corporate Stakeholder Update Details for BZ, Full KYC
...
```typescript
import { BZFullCorporateStakeholderDetailsUpdate } from 'nium-client';

const instance: BZFullCorporateStakeholderDetailsUpdate = {
    externalId,
    businessName,
