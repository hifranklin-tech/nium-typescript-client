# UKFullSoleTraderWithoutSearchIdCustomerDetailsUpdate
...
```typescript
import { UKFullSoleTraderWithoutSearchIdCustomerDetailsUpdate } from 'nium-client';

const instance: UKFullSoleTraderWithoutSearchIdCustomerDetailsUpdate = {
