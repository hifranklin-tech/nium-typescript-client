# USFullLimitedLiabilityPartnershipCustomerDetails
...
```typescript
import { USFullLimitedLiabilityPartnershipCustomerDetails } from 'nium-client';

const instance: USFullLimitedLiabilityPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
