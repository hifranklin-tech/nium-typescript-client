# UKFullPublicCompanyWithSearchIdCustomerDetailsResponse
...
```typescript
import { UKFullPublicCompanyWithSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: UKFullPublicCompanyWithSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
