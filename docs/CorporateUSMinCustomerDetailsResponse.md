# CorporateUSMinCustomerDetailsResponse
...
```typescript
import { CorporateUSMinCustomerDetailsResponse } from 'nium-client';

const instance: CorporateUSMinCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
