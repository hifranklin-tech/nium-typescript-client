# SGFullPublicCompanyWithoutSearchIdCustomerDetailsResponse
...
```typescript
import { SGFullPublicCompanyWithoutSearchIdCustomerDetailsResponse } from 'nium-client';

const instance: SGFullPublicCompanyWithoutSearchIdCustomerDetailsResponse = {
    wallets,
    customerHashId,
    referenceId,
    status,
