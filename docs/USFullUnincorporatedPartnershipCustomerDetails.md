# USFullUnincorporatedPartnershipCustomerDetails
...
```typescript
import { USFullUnincorporatedPartnershipCustomerDetails } from 'nium-client';

const instance: USFullUnincorporatedPartnershipCustomerDetails = {
    type,
    kycType,
    region,
    externalId,
