# IndividualCAFullCustomerDetailsUpdate
...
```typescript
import { IndividualCAFullCustomerDetailsUpdate } from 'nium-client';

const instance: IndividualCAFullCustomerDetailsUpdate = {
    type,
    kycType,
    region,
    externalId,
